...
//  SpotHopper
//
//  Created by SpotHopper on 7/2/14.
...
+ (void)drawDeleteIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(182.29, 147.77)];
        [bezierPath addCurveToPoint: CGPointMake(508.61, 474.1) controlPoint1: CGPointMake(182.28, 147.77) controlPoint2: CGPointMake(343.22, 308.71)];
        [bezierPath addCurveToPoint: CGPointMake(834.94, 147.77) controlPoint1: CGPointMake(674.01, 308.71) controlPoint2: CGPointMake(834.94, 147.77)];
        [bezierPath addLineToPoint: CGPointMake(863.23, 176.06)];
        [bezierPath addCurveToPoint: CGPointMake(536.9, 502.39) controlPoint1: CGPointMake(863.23, 176.06) controlPoint2: CGPointMake(702.29, 336.99)];
        [bezierPath addCurveToPoint: CGPointMake(863.23, 828.72) controlPoint1: CGPointMake(702.29, 667.78) controlPoint2: CGPointMake(863.23, 828.72)];
        [bezierPath addLineToPoint: CGPointMake(834.94, 857)];
        [bezierPath addCurveToPoint: CGPointMake(508.61, 530.67) controlPoint1: CGPointMake(834.94, 857) controlPoint2: CGPointMake(674.01, 696.06)];
        [bezierPath addCurveToPoint: CGPointMake(182.28, 857) controlPoint1: CGPointMake(343.22, 696.07) controlPoint2: CGPointMake(182.28, 857)];
        [bezierPath addLineToPoint: CGPointMake(154, 828.72)];
        [bezierPath addCurveToPoint: CGPointMake(480.33, 502.39) controlPoint1: CGPointMake(154, 828.72) controlPoint2: CGPointMake(314.94, 667.78)];
        [bezierPath addCurveToPoint: CGPointMake(154, 176.06) controlPoint1: CGPointMake(314.93, 336.99) controlPoint2: CGPointMake(154, 176.06)];
        [bezierPath addLineToPoint: CGPointMake(182.28, 147.77)];
        [bezierPath addLineToPoint: CGPointMake(182.29, 147.77)];
        [bezierPath closePath];
        [strokeColor setFill];
        [bezierPath fill];
