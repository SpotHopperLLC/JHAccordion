...
//  SpotHopper
//
//  Created by SpotHopper on 10/20/14.
...
+ (void)initialize
{
    ...
    _myDarkShadowGradient = [PCGradient gradientWithColors: @[SHStyleKit.myBlackTransparentColor, [UIColor colorWithRed: 0.5 green: 0.5 blue: 0.5 alpha: 0.375], SHStyleKit.myClearColor] locations: myDarkShadowGradientLocations];
    CGFloat myLightShadowGradientLocations[] = {0, 0.51, 1};
    _myLightShadowGradient = [PCGradient gradientWithColors: @[SHStyleKit.myTextTransparentColor, [UIColor colorWithRed: 0.7 green: 0.7 blue: 0.7 alpha: 0.1], SHStyleKit.myClearColor] locations: myLightShadowGradientLocations];
...
+ (void)drawGradientBackgroundWithWidth: (CGFloat)width height: (CGFloat)height scaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY;
{
    ...
    //// Group
    {
        ...
        CGContextDrawLinearGradient(context, myTintColorGradient.CGGradient, CGPointMake(160, -0), CGPointMake(160, 568), 0);
        CGContextRestoreGState(context);
