...
//  SpotHopper
//
//  Created by SpotHopper on 8/18/14.
...
+ (void)drawSpotIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(503.52, 1017.53)];
        [bezierPath addLineToPoint: CGPointMake(232.82, 488.83)];
        [bezierPath addCurveToPoint: CGPointMake(183.72, 319.23) controlPoint1: CGPointMake(200.72, 438.03) controlPoint2: CGPointMake(183.72, 379.37)];
        [bezierPath addCurveToPoint: CGPointMake(504.82, 0) controlPoint1: CGPointMake(183.72, 143.16) controlPoint2: CGPointMake(327.82, 0)];
        [bezierPath addCurveToPoint: CGPointMake(825.92, 319.23) controlPoint1: CGPointMake(681.82, 0) controlPoint2: CGPointMake(825.92, 143.26)];
        [bezierPath addCurveToPoint: CGPointMake(777.02, 488.53) controlPoint1: CGPointMake(825.92, 379.27) controlPoint2: CGPointMake(809.02, 437.83)];
        [bezierPath addLineToPoint: CGPointMake(503.52, 1017.53)];
        [bezierPath closePath];
        [bezierPath moveToPoint: CGPointMake(504.82, 46.43)];
        [bezierPath addCurveToPoint: CGPointMake(230.42, 319.23) controlPoint1: CGPointMake(353.52, 46.43) controlPoint2: CGPointMake(230.42, 168.81)];
        [bezierPath addCurveToPoint: CGPointMake(272.92, 464.87) controlPoint1: CGPointMake(230.42, 370.92) controlPoint2: CGPointMake(245.12, 421.33)];
        [bezierPath addLineToPoint: CGPointMake(274.02, 466.76)];
        [bezierPath addLineToPoint: CGPointMake(503.82, 915.43)];
        [bezierPath addLineToPoint: CGPointMake(736.92, 464.57)];
        [bezierPath addCurveToPoint: CGPointMake(779.22, 319.23) controlPoint1: CGPointMake(764.62, 421.03) controlPoint2: CGPointMake(779.22, 370.72)];
        [bezierPath addCurveToPoint: CGPointMake(504.82, 46.43) controlPoint1: CGPointMake(779.12, 168.81) controlPoint2: CGPointMake(656.12, 46.43)];
        [bezierPath closePath];
        [bezierPath moveToPoint: CGPointMake(509.82, 456.42)];
        [bezierPath addCurveToPoint: CGPointMake(395.92, 343.19) controlPoint1: CGPointMake(447.02, 456.42) controlPoint2: CGPointMake(395.92, 405.62)];
        [bezierPath addCurveToPoint: CGPointMake(509.82, 229.85) controlPoint1: CGPointMake(395.92, 280.75) controlPoint2: CGPointMake(447.02, 229.85)];
        [bezierPath addCurveToPoint: CGPointMake(623.72, 343.19) controlPoint1: CGPointMake(572.62, 229.85) controlPoint2: CGPointMake(623.72, 280.65)];
        [bezierPath addCurveToPoint: CGPointMake(509.82, 456.42) controlPoint1: CGPointMake(623.72, 405.72) controlPoint2: CGPointMake(572.62, 456.42)];
        [bezierPath closePath];
        [bezierPath moveToPoint: CGPointMake(509.82, 264.65)];
        [bezierPath addCurveToPoint: CGPointMake(430.92, 343.09) controlPoint1: CGPointMake(466.32, 264.65) controlPoint2: CGPointMake(430.92, 299.84)];
        [bezierPath addCurveToPoint: CGPointMake(509.82, 421.53) controlPoint1: CGPointMake(430.92, 386.33) controlPoint2: CGPointMake(466.32, 421.53)];
        [bezierPath addCurveToPoint: CGPointMake(588.72, 343.09) controlPoint1: CGPointMake(553.32, 421.53) controlPoint2: CGPointMake(588.72, 386.33)];
        [bezierPath addCurveToPoint: CGPointMake(509.82, 264.65) controlPoint1: CGPointMake(588.72, 299.84) controlPoint2: CGPointMake(553.32, 264.65)];
        [bezierPath closePath];
        [strokeColor setFill];
        [bezierPath fill];
