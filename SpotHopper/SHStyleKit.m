...
+ (void)drawNavigationArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(317.87, 0)];
        [bezierPath addLineToPoint: CGPointMake(290.27, 22.8)];
        [bezierPath addLineToPoint: CGPointMake(692.07, 509.2)];
        [bezierPath addLineToPoint: CGPointMake(290.27, 995.6)];
        [bezierPath addLineToPoint: CGPointMake(317.87, 1018.4)];
        [bezierPath addLineToPoint: CGPointMake(738.47, 509.2)];
        [bezierPath addLineToPoint: CGPointMake(317.87, 0)];
        [bezierPath closePath];
        bezierPath.miterLimit = 4;
...
+ (void)drawNextArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(1019.32, 503.9)];
        [bezierPath addCurveToPoint: CGPointMake(1018.82, 498.5) controlPoint1: CGPointMake(1019.12, 502.1) controlPoint2: CGPointMake(1019.12, 500.3)];
        [bezierPath addCurveToPoint: CGPointMake(997, 459.7) controlPoint1: CGPointMake(1015.92, 483.2) controlPoint2: CGPointMake(1008.01, 469.8)];
        [bezierPath addLineToPoint: CGPointMake(625.03, 87.4)];
        [bezierPath addCurveToPoint: CGPointMake(524.84, 87.3) controlPoint1: CGPointMake(597.41, 59.7) controlPoint2: CGPointMake(552.46, 59.7)];
        [bezierPath addLineToPoint: CGPointMake(523.83, 88.3)];
        [bezierPath addCurveToPoint: CGPointMake(523.73, 188.4) controlPoint1: CGPointMake(496.11, 115.9) controlPoint2: CGPointMake(496.11, 160.8)];
        [bezierPath addLineToPoint: CGPointMake(775.98, 440.9)];
        [bezierPath addLineToPoint: CGPointMake(72.79, 440.9)];
        [bezierPath addCurveToPoint: CGPointMake(1.92, 511.7) controlPoint1: CGPointMake(33.65, 440.9) controlPoint2: CGPointMake(1.92, 472.6)];
        [bezierPath addLineToPoint: CGPointMake(1.92, 513.1)];
        [bezierPath addCurveToPoint: CGPointMake(72.79, 583.9) controlPoint1: CGPointMake(1.92, 552.2) controlPoint2: CGPointMake(33.65, 583.9)];
        [bezierPath addLineToPoint: CGPointMake(775.98, 583.9)];
        [bezierPath addLineToPoint: CGPointMake(523.73, 836.4)];
        [bezierPath addCurveToPoint: CGPointMake(523.83, 936.5) controlPoint1: CGPointMake(496.11, 864.1) controlPoint2: CGPointMake(496.11, 908.9)];
        [bezierPath addLineToPoint: CGPointMake(524.84, 937.5)];
        [bezierPath addCurveToPoint: CGPointMake(625.03, 937.4) controlPoint1: CGPointMake(552.56, 965.1) controlPoint2: CGPointMake(597.41, 965.1)];
        [bezierPath addLineToPoint: CGPointMake(997, 565.1)];
        [bezierPath addCurveToPoint: CGPointMake(1018.82, 526.3) controlPoint1: CGPointMake(1008.01, 555) controlPoint2: CGPointMake(1015.92, 541.6)];
        [bezierPath addCurveToPoint: CGPointMake(1019.32, 520.9) controlPoint1: CGPointMake(1019.12, 524.5) controlPoint2: CGPointMake(1019.12, 522.7)];
        [bezierPath addCurveToPoint: CGPointMake(1020.12, 513.1) controlPoint1: CGPointMake(1019.62, 518.3) controlPoint2: CGPointMake(1020.12, 515.8)];
        [bezierPath addLineToPoint: CGPointMake(1020.12, 511.7)];
        [bezierPath addCurveToPoint: CGPointMake(1019.32, 503.9) controlPoint1: CGPointMake(1020.12, 509) controlPoint2: CGPointMake(1019.62, 506.5)];
        [bezierPath closePath];
        bezierPath.miterLimit = 4;
...
+ (void)drawPreviousArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(4.2, 503.9)];
        [bezierPath addCurveToPoint: CGPointMake(4.7, 498.5) controlPoint1: CGPointMake(4.4, 502.1) controlPoint2: CGPointMake(4.4, 500.3)];
        [bezierPath addCurveToPoint: CGPointMake(26.5, 459.7) controlPoint1: CGPointMake(7.6, 483.2) controlPoint2: CGPointMake(15.5, 469.8)];
        [bezierPath addLineToPoint: CGPointMake(398.1, 87.4)];
        [bezierPath addCurveToPoint: CGPointMake(498.2, 87.3) controlPoint1: CGPointMake(425.7, 59.7) controlPoint2: CGPointMake(470.6, 59.7)];
        [bezierPath addLineToPoint: CGPointMake(499.2, 88.3)];
        [bezierPath addCurveToPoint: CGPointMake(499.3, 188.4) controlPoint1: CGPointMake(526.9, 115.9) controlPoint2: CGPointMake(526.9, 160.8)];
        [bezierPath addLineToPoint: CGPointMake(247.3, 440.9)];
        [bezierPath addLineToPoint: CGPointMake(949.8, 440.9)];
        [bezierPath addCurveToPoint: CGPointMake(1020.6, 511.7) controlPoint1: CGPointMake(988.9, 440.9) controlPoint2: CGPointMake(1020.6, 472.6)];
        [bezierPath addLineToPoint: CGPointMake(1020.6, 513.1)];
        [bezierPath addCurveToPoint: CGPointMake(949.8, 583.9) controlPoint1: CGPointMake(1020.6, 552.2) controlPoint2: CGPointMake(988.9, 583.9)];
        [bezierPath addLineToPoint: CGPointMake(247.3, 583.9)];
        [bezierPath addLineToPoint: CGPointMake(499.3, 836.4)];
        [bezierPath addCurveToPoint: CGPointMake(499.2, 936.5) controlPoint1: CGPointMake(526.9, 864.1) controlPoint2: CGPointMake(526.9, 908.9)];
        [bezierPath addLineToPoint: CGPointMake(498.2, 937.5)];
        [bezierPath addCurveToPoint: CGPointMake(398.1, 937.4) controlPoint1: CGPointMake(470.5, 965.1) controlPoint2: CGPointMake(425.7, 965.1)];
        [bezierPath addLineToPoint: CGPointMake(26.5, 565.1)];
        [bezierPath addCurveToPoint: CGPointMake(4.7, 526.3) controlPoint1: CGPointMake(15.5, 555) controlPoint2: CGPointMake(7.6, 541.6)];
        [bezierPath addCurveToPoint: CGPointMake(4.2, 520.9) controlPoint1: CGPointMake(4.4, 524.5) controlPoint2: CGPointMake(4.4, 522.7)];
        [bezierPath addCurveToPoint: CGPointMake(3.4, 513.1) controlPoint1: CGPointMake(3.9, 518.3) controlPoint2: CGPointMake(3.4, 515.8)];
        [bezierPath addLineToPoint: CGPointMake(3.4, 511.7)];
        [bezierPath addCurveToPoint: CGPointMake(4.2, 503.9) controlPoint1: CGPointMake(3.4, 509) controlPoint2: CGPointMake(3.9, 506.5)];
        [bezierPath closePath];
        bezierPath.miterLimit = 4;
...
+ (void)drawMapBubblePinFilledIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY;
{
    ...
    UIColor* color9 = [UIColor colorWithRed: 0.931 green: 0.931 blue: 0.936 alpha: 0.56];
    UIColor* color10 = [UIColor colorWithRed: 0.586 green: 0.594 blue: 0.607 alpha: 0.56];
    ...
    CGGradientRef myMapPinShadow = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)color9.CGColor, (id)color10.CGColor, (id)color9.CGColor], myMapPinShadowLocations);
