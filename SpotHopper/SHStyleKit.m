...
//  SpotHopper
//
//  Created by SpotHopper on 12/23/14.
...
static PCGradient* _myWhiteShadowGradient = nil;
static PCGradient* _myDarkShadowGradient = nil;
static PCGradient* _myLightShadowGradient = nil;
...
+ (void)initialize
{
    ...
    _myWhiteShadowGradient = [PCGradient gradientWithColors: @[SHStyleKit.myWhiteTransparentColor, SHStyleKit.myClearColor] locations: myWhiteShadowGradientLocations];
    CGFloat myDarkShadowGradientLocations[] = {0, 0.62, 1};
    _myDarkShadowGradient = [PCGradient gradientWithColors: @[SHStyleKit.myBlackTransparentColor, [SHStyleKit.myBlackTransparentColor blendedColorWithFraction: 0.5 ofColor: SHStyleKit.myClearColor], SHStyleKit.myClearColor] locations: myDarkShadowGradientLocations];
    CGFloat myLightShadowGradientLocations[] = {0, 0.51, 1};
    _myLightShadowGradient = [PCGradient gradientWithColors: @[SHStyleKit.myTextTransparentColor, [SHStyleKit.myTextTransparentColor blendedColorWithFraction: 0.5 ofColor: SHStyleKit.myClearColor], SHStyleKit.myClearColor] locations: myLightShadowGradientLocations];
...
+ (PCGradient*)myWhiteShadowGradient { return _myWhiteShadowGradient; }
+ (PCGradient*)myDarkShadowGradient { return _myDarkShadowGradient; }
+ (PCGradient*)myLightShadowGradient { return _myLightShadowGradient; }
...
+ (void)drawNavigationArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName rotation: (CGFloat)rotation
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
...
+ (void)drawShareIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY color1Name: (NSString*)color1Name color2Name: (NSString*)color2Name color3Name: (NSString*)color3Name
{
    ...
    //// Variable Declarations
    UIColor* myColor1 = [color1Name isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([color1Name isEqualToString: @"myTintColorTransparent"] ? SHStyleKit.myTintTransparentColor : ([color1Name isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([color1Name isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([color1Name isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([color1Name isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([color1Name isEqualToString: @"default"] ? SHStyleKit.myTintColor : SHStyleKit.myClearColor))))));
    UIColor* myColor2 = [color2Name isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([color2Name isEqualToString: @"myTintColorTransparent"] ? SHStyleKit.myTintTransparentColor : ([color2Name isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([color2Name isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([color2Name isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([color2Name isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([color2Name isEqualToString: @"default"] ? SHStyleKit.myTintColor : SHStyleKit.myClearColor))))));
    UIColor* myColor3 = [color3Name isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([color3Name isEqualToString: @"myTintColorTransparent"] ? SHStyleKit.myTintTransparentColor : ([color3Name isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([color3Name isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([color3Name isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([color3Name isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([color3Name isEqualToString: @"default"] ? SHStyleKit.myTintColor : SHStyleKit.myClearColor))))));
...
+ (void)drawReviewsIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName fillColorName: (NSString*)fillColorName
{
    ...
    //// Group
    {
        ...
        //// White Bezier Drawing
        UIBezierPath* whiteBezierPath = UIBezierPath.bezierPath;
        [whiteBezierPath moveToPoint: CGPointMake(540.87, 727.37)];
        [whiteBezierPath addLineToPoint: CGPointMake(373.47, 548.17)];
        [whiteBezierPath addLineToPoint: CGPointMake(379.57, 542.47)];
        [whiteBezierPath addLineToPoint: CGPointMake(856.87, 96.77)];
        [whiteBezierPath addLineToPoint: CGPointMake(1024.27, 275.97)];
        [whiteBezierPath addLineToPoint: CGPointMake(1018.17, 281.67)];
        [whiteBezierPath addLineToPoint: CGPointMake(540.87, 727.37)];
        [whiteBezierPath closePath];
        [whiteBezierPath moveToPoint: CGPointMake(396.97, 548.97)];
        [whiteBezierPath addLineToPoint: CGPointMake(541.67, 703.87)];
        [whiteBezierPath addLineToPoint: CGPointMake(1000.77, 275.17)];
        [whiteBezierPath addLineToPoint: CGPointMake(856.07, 120.27)];
        [whiteBezierPath addLineToPoint: CGPointMake(396.97, 548.97)];
        [whiteBezierPath closePath];
        [whiteBezierPath moveToPoint: CGPointMake(284.37, 809.07)];
        [whiteBezierPath addLineToPoint: CGPointMake(363.17, 543.97)];
        [whiteBezierPath addLineToPoint: CGPointMake(553.27, 744.77)];
        [whiteBezierPath addLineToPoint: CGPointMake(284.37, 809.07)];
        [whiteBezierPath closePath];
        [whiteBezierPath moveToPoint: CGPointMake(370.87, 576.37)];
        [whiteBezierPath addLineToPoint: CGPointMake(308.57, 786.17)];
        [whiteBezierPath addLineToPoint: CGPointMake(521.47, 735.27)];
        [whiteBezierPath addLineToPoint: CGPointMake(370.87, 576.37)];
        [whiteBezierPath closePath];
        [strokeColor setFill];
        [whiteBezierPath fill];


        //// Tinted Bezier Drawing
        UIBezierPath* tintedBezierPath = UIBezierPath.bezierPath;
        [tintedBezierPath moveToPoint: CGPointMake(664.57, 212.07)];
        [tintedBezierPath addCurveToPoint: CGPointMake(664.57, 245.37) controlPoint1: CGPointMake(664.57, 212.07) controlPoint2: CGPointMake(664.57, 245.37)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 245.37)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 212.07)];
        [tintedBezierPath addLineToPoint: CGPointMake(664.57, 212.07)];
        [tintedBezierPath addLineToPoint: CGPointMake(664.57, 212.07)];
        [tintedBezierPath closePath];
        [tintedBezierPath moveToPoint: CGPointMake(642.27, 67.47)];
        [tintedBezierPath addLineToPoint: CGPointMake(138.17, 67.47)];
        [tintedBezierPath addCurveToPoint: CGPointMake(39.57, 166.07) controlPoint1: CGPointMake(83.77, 67.47) controlPoint2: CGPointMake(39.57, 111.67)];
        [tintedBezierPath addLineToPoint: CGPointMake(39.57, 857.87)];
        [tintedBezierPath addCurveToPoint: CGPointMake(138.17, 956.47) controlPoint1: CGPointMake(39.57, 912.27) controlPoint2: CGPointMake(83.77, 956.47)];
        [tintedBezierPath addLineToPoint: CGPointMake(642.27, 956.47)];
        [tintedBezierPath addCurveToPoint: CGPointMake(740.87, 857.87) controlPoint1: CGPointMake(696.67, 956.47) controlPoint2: CGPointMake(740.87, 912.17)];
        [tintedBezierPath addCurveToPoint: CGPointMake(740.87, 529.21) controlPoint1: CGPointMake(740.87, 857.87) controlPoint2: CGPointMake(740.87, 696.23)];
        [tintedBezierPath addCurveToPoint: CGPointMake(541.21, 715.64) controlPoint1: CGPointMake(636.19, 626.95) controlPoint2: CGPointMake(541.21, 715.64)];
        [tintedBezierPath addCurveToPoint: CGPointMake(404.25, 568.97) controlPoint1: CGPointMake(541.21, 715.64) controlPoint2: CGPointMake(445.88, 613.54)];
        [tintedBezierPath addLineToPoint: CGPointMake(375.3, 568.97)];
        [tintedBezierPath addCurveToPoint: CGPointMake(537.37, 740.07) controlPoint1: CGPointMake(409.51, 605.09) controlPoint2: CGPointMake(537.37, 740.07)];
        [tintedBezierPath addLineToPoint: CGPointMake(296.37, 797.67)];
        [tintedBezierPath addCurveToPoint: CGPointMake(364.35, 568.97) controlPoint1: CGPointMake(296.37, 797.67) controlPoint2: CGPointMake(351.58, 611.94)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 568.97)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 535.67)];
        [tintedBezierPath addLineToPoint: CGPointMake(399, 535.67)];
        [tintedBezierPath addCurveToPoint: CGPointMake(541, 403.07) controlPoint1: CGPointMake(423.48, 512.81) controlPoint2: CGPointMake(477.91, 461.98)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 403.07)];
        [tintedBezierPath addLineToPoint: CGPointMake(130.77, 369.77)];
        [tintedBezierPath addLineToPoint: CGPointMake(576.66, 369.77)];
        [tintedBezierPath addCurveToPoint: CGPointMake(740.87, 216.44) controlPoint1: CGPointMake(632.33, 317.78) controlPoint2: CGPointMake(691.41, 262.61)];
        [tintedBezierPath addCurveToPoint: CGPointMake(740.87, 166.07) controlPoint1: CGPointMake(740.87, 184.94) controlPoint2: CGPointMake(740.87, 166.07)];
        [tintedBezierPath addCurveToPoint: CGPointMake(642.27, 67.47) controlPoint1: CGPointMake(740.87, 111.67) controlPoint2: CGPointMake(696.67, 67.47)];
        [tintedBezierPath closePath];
        [tintedBezierPath moveToPoint: CGPointMake(774.17, 166.07)];
        [tintedBezierPath addCurveToPoint: CGPointMake(774.17, 185.34) controlPoint1: CGPointMake(774.17, 166.07) controlPoint2: CGPointMake(774.17, 172.95)];
        [tintedBezierPath addCurveToPoint: CGPointMake(856.4, 108.55) controlPoint1: CGPointMake(823.08, 139.66) controlPoint2: CGPointMake(856.4, 108.55)];
        [tintedBezierPath addLineToPoint: CGPointMake(1012.42, 275.63)];
        [tintedBezierPath addCurveToPoint: CGPointMake(774.17, 498.11) controlPoint1: CGPointMake(1012.42, 275.63) controlPoint2: CGPointMake(892.85, 387.29)];
        [tintedBezierPath addCurveToPoint: CGPointMake(774.17, 857.87) controlPoint1: CGPointMake(774.17, 675.56) controlPoint2: CGPointMake(774.17, 857.87)];
        [tintedBezierPath addCurveToPoint: CGPointMake(642.27, 989.77) controlPoint1: CGPointMake(774.27, 930.57) controlPoint2: CGPointMake(715.07, 989.77)];
        [tintedBezierPath addLineToPoint: CGPointMake(138.17, 989.77)];
        [tintedBezierPath addCurveToPoint: CGPointMake(6.27, 857.87) controlPoint1: CGPointMake(65.47, 989.77) controlPoint2: CGPointMake(6.27, 930.57)];
        [tintedBezierPath addLineToPoint: CGPointMake(6.27, 166.07)];
        [tintedBezierPath addCurveToPoint: CGPointMake(138.17, 34.17) controlPoint1: CGPointMake(6.27, 93.37) controlPoint2: CGPointMake(65.47, 34.17)];
        [tintedBezierPath addLineToPoint: CGPointMake(642.27, 34.17)];
        [tintedBezierPath addCurveToPoint: CGPointMake(774.17, 166.07) controlPoint1: CGPointMake(714.97, 34.17) controlPoint2: CGPointMake(774.17, 93.37)];
        [tintedBezierPath closePath];
        [fillColor setFill];
        [tintedBezierPath fill];
...
+ (void)drawStarIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName fillColorName: (NSString*)fillColorName
{
    ...
    //// Group
    {
        ...
        [starPath moveToPoint: CGPointMake(509.49, 52.2)];
        [starPath addLineToPoint: CGPointMake(652.04, 341.12)];
        [starPath addLineToPoint: CGPointMake(971, 387.49)];
        [starPath addLineToPoint: CGPointMake(740.2, 612.42)];
        [starPath addLineToPoint: CGPointMake(794.67, 930)];
        [starPath addLineToPoint: CGPointMake(509.49, 780.11)];
        [starPath addLineToPoint: CGPointMake(224.23, 930)];
        [starPath addLineToPoint: CGPointMake(278.7, 612.42)];
        [starPath addLineToPoint: CGPointMake(47.9, 387.49)];
        [starPath addLineToPoint: CGPointMake(366.86, 341.12)];
        [starPath addLineToPoint: CGPointMake(509.49, 52.2)];
        [starPath closePath];
...
+ (void)drawMoreIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName
{
    ...
    //// Group
    {
        ...
        [dotsPath moveToPoint: CGPointMake(277.38, 550.38)];
        [dotsPath addCurveToPoint: CGPointMake(277.38, 455.62) controlPoint1: CGPointMake(303.54, 524.21) controlPoint2: CGPointMake(303.54, 481.79)];
        [dotsPath addCurveToPoint: CGPointMake(182.62, 455.62) controlPoint1: CGPointMake(251.21, 429.46) controlPoint2: CGPointMake(208.79, 429.46)];
        [dotsPath addCurveToPoint: CGPointMake(182.62, 550.38) controlPoint1: CGPointMake(156.46, 481.79) controlPoint2: CGPointMake(156.46, 524.21)];
        [dotsPath addCurveToPoint: CGPointMake(277.38, 550.38) controlPoint1: CGPointMake(208.79, 576.54) controlPoint2: CGPointMake(251.21, 576.54)];
        [dotsPath closePath];
        [dotsPath moveToPoint: CGPointMake(565.38, 550.38)];
        [dotsPath addCurveToPoint: CGPointMake(565.38, 455.62) controlPoint1: CGPointMake(591.54, 524.21) controlPoint2: CGPointMake(591.54, 481.79)];
        [dotsPath addCurveToPoint: CGPointMake(470.62, 455.62) controlPoint1: CGPointMake(539.21, 429.46) controlPoint2: CGPointMake(496.79, 429.46)];
        [dotsPath addCurveToPoint: CGPointMake(470.62, 550.38) controlPoint1: CGPointMake(444.46, 481.79) controlPoint2: CGPointMake(444.46, 524.21)];
        [dotsPath addCurveToPoint: CGPointMake(565.38, 550.38) controlPoint1: CGPointMake(496.79, 576.54) controlPoint2: CGPointMake(539.21, 576.54)];
        [dotsPath closePath];
        [dotsPath moveToPoint: CGPointMake(848.38, 550.38)];
        [dotsPath addCurveToPoint: CGPointMake(848.38, 455.62) controlPoint1: CGPointMake(874.54, 524.21) controlPoint2: CGPointMake(874.54, 481.79)];
        [dotsPath addCurveToPoint: CGPointMake(753.62, 455.62) controlPoint1: CGPointMake(822.21, 429.46) controlPoint2: CGPointMake(779.79, 429.46)];
        [dotsPath addCurveToPoint: CGPointMake(753.62, 550.38) controlPoint1: CGPointMake(727.46, 481.79) controlPoint2: CGPointMake(727.46, 524.21)];
        [dotsPath addCurveToPoint: CGPointMake(848.38, 550.38) controlPoint1: CGPointMake(779.79, 576.54) controlPoint2: CGPointMake(822.21, 576.54)];
        [dotsPath closePath];
        [fillColor setFill];
        [dotsPath fill];
...
+ (void)drawClockIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName
{
    ...
    //// Group
    {
        ...
        //// Clock Drawing
        UIBezierPath* clockPath = UIBezierPath.bezierPath;
        [clockPath moveToPoint: CGPointMake(515.85, 1023.87)];
        [clockPath addCurveToPoint: CGPointMake(7.95, 515.97) controlPoint1: CGPointMake(235.75, 1023.87) controlPoint2: CGPointMake(7.95, 795.97)];
        [clockPath addCurveToPoint: CGPointMake(515.85, 8.07) controlPoint1: CGPointMake(7.95, 235.87) controlPoint2: CGPointMake(235.75, 8.07)];
        [clockPath addCurveToPoint: CGPointMake(1023.75, 515.97) controlPoint1: CGPointMake(795.95, 8.07) controlPoint2: CGPointMake(1023.75, 235.97)];
        [clockPath addCurveToPoint: CGPointMake(515.85, 1023.87) controlPoint1: CGPointMake(1023.75, 796.07) controlPoint2: CGPointMake(795.95, 1023.87)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(515.85, 96.67)];
        [clockPath addCurveToPoint: CGPointMake(96.55, 515.97) controlPoint1: CGPointMake(284.65, 96.67) controlPoint2: CGPointMake(96.55, 284.77)];
        [clockPath addCurveToPoint: CGPointMake(515.85, 935.27) controlPoint1: CGPointMake(96.55, 747.17) controlPoint2: CGPointMake(284.65, 935.27)];
        [clockPath addCurveToPoint: CGPointMake(935.15, 515.97) controlPoint1: CGPointMake(747.05, 935.27) controlPoint2: CGPointMake(935.15, 747.17)];
        [clockPath addCurveToPoint: CGPointMake(515.85, 96.67) controlPoint1: CGPointMake(935.15, 284.77) controlPoint2: CGPointMake(747.05, 96.67)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(122.65, 537.47)];
        [clockPath addLineToPoint: CGPointMake(247.85, 537.47)];
        [clockPath addLineToPoint: CGPointMake(247.85, 474.87)];
        [clockPath addLineToPoint: CGPointMake(122.65, 474.87)];
        [clockPath addLineToPoint: CGPointMake(122.65, 537.47)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(795.55, 537.47)];
        [clockPath addLineToPoint: CGPointMake(920.75, 537.47)];
        [clockPath addLineToPoint: CGPointMake(920.75, 474.87)];
        [clockPath addLineToPoint: CGPointMake(795.55, 474.87)];
        [clockPath addLineToPoint: CGPointMake(795.55, 537.47)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(547.82, 108.08)];
        [clockPath addLineToPoint: CGPointMake(546.54, 233.27)];
        [clockPath addLineToPoint: CGPointMake(483.95, 232.63)];
        [clockPath addLineToPoint: CGPointMake(485.23, 107.44)];
        [clockPath addLineToPoint: CGPointMake(547.82, 108.08)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(547.83, 796.16)];
        [clockPath addLineToPoint: CGPointMake(546.55, 921.35)];
        [clockPath addLineToPoint: CGPointMake(483.96, 920.71)];
        [clockPath addLineToPoint: CGPointMake(485.24, 795.52)];
        [clockPath addLineToPoint: CGPointMake(547.83, 796.16)];
        [clockPath closePath];
        [clockPath moveToPoint: CGPointMake(746.15, 284.67)];
        [clockPath addCurveToPoint: CGPointMake(583.59, 503.42) controlPoint1: CGPointMake(746.15, 284.67) controlPoint2: CGPointMake(616.54, 459.09)];
        [clockPath addCurveToPoint: CGPointMake(575.8, 537.87) controlPoint1: CGPointMake(584.07, 515.24) controlPoint2: CGPointMake(581.47, 527.15)];
        [clockPath addCurveToPoint: CGPointMake(615.25, 636.27) controlPoint1: CGPointMake(588.18, 568.76) controlPoint2: CGPointMake(615.25, 636.27)];
        [clockPath addCurveToPoint: CGPointMake(520.7, 573.8) controlPoint1: CGPointMake(615.25, 636.27) controlPoint2: CGPointMake(543.85, 589.1)];
        [clockPath addCurveToPoint: CGPointMake(467.91, 554.11) controlPoint1: CGPointMake(501.77, 575.15) controlPoint2: CGPointMake(482.38, 568.59)];
        [clockPath addCurveToPoint: CGPointMake(467.91, 458.23) controlPoint1: CGPointMake(441.43, 527.64) controlPoint2: CGPointMake(441.43, 484.71)];
        [clockPath addCurveToPoint: CGPointMake(528.93, 439.64) controlPoint1: CGPointMake(484.49, 441.65) controlPoint2: CGPointMake(507.52, 435.45)];
        [clockPath addCurveToPoint: CGPointMake(746.15, 284.67) controlPoint1: CGPointMake(577.7, 404.85) controlPoint2: CGPointMake(746.15, 284.67)];
        [clockPath addLineToPoint: CGPointMake(746.15, 284.67)];
        [clockPath closePath];
        [fillColor setFill];
        [clockPath fill];
...
+ (void)drawPhoneIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName
{
    ...
    //// Group
    {
        ...
        [phonePath moveToPoint: CGPointMake(339.82, 16.46)];
        [phonePath addCurveToPoint: CGPointMake(464.02, 245.36) controlPoint1: CGPointMake(403.42, 74.36) controlPoint2: CGPointMake(443.22, 152.06)];
        [phonePath addCurveToPoint: CGPointMake(456.52, 282.36) controlPoint1: CGPointMake(470.82, 257.86) controlPoint2: CGPointMake(467.62, 273.46)];
        [phonePath addCurveToPoint: CGPointMake(355.72, 348.46) controlPoint1: CGPointMake(433.22, 314.96) controlPoint2: CGPointMake(398.22, 335.46)];
        [phonePath addCurveToPoint: CGPointMake(349.22, 385.46) controlPoint1: CGPointMake(344.52, 357.36) controlPoint2: CGPointMake(341.72, 373.26)];
        [phonePath addLineToPoint: CGPointMake(554.32, 725.06)];
        [phonePath addCurveToPoint: CGPointMake(593.72, 734.26) controlPoint1: CGPointMake(562.62, 738.56) controlPoint2: CGPointMake(580.32, 742.76)];
        [phonePath addCurveToPoint: CGPointMake(681.52, 672.46) controlPoint1: CGPointMake(622.82, 705.26) controlPoint2: CGPointMake(651.82, 681.16)];
        [phonePath addCurveToPoint: CGPointMake(715.92, 674.56) controlPoint1: CGPointMake(692.22, 665.66) controlPoint2: CGPointMake(706.12, 666.56)];
        [phonePath addCurveToPoint: CGPointMake(919.12, 840.96) controlPoint1: CGPointMake(793.72, 718.06) controlPoint2: CGPointMake(860.52, 774.56)];
        [phonePath addCurveToPoint: CGPointMake(916.82, 888.16) controlPoint1: CGPointMake(934.42, 853.46) controlPoint2: CGPointMake(933.22, 877.26)];
        [phonePath addCurveToPoint: CGPointMake(734.12, 1009.96) controlPoint1: CGPointMake(878.42, 958.06) controlPoint2: CGPointMake(814.92, 995.26)];
        [phonePath addCurveToPoint: CGPointMake(140.22, 117.76) controlPoint1: CGPointMake(367.82, 851.46) controlPoint2: CGPointMake(148.22, 571.56)];
        [phonePath addCurveToPoint: CGPointMake(296.92, 6.46) controlPoint1: CGPointMake(186.32, 57.86) controlPoint2: CGPointMake(238.12, 18.96)];
        [phonePath addCurveToPoint: CGPointMake(339.82, 16.46) controlPoint1: CGPointMake(311.32, -3.74) controlPoint2: CGPointMake(331.42, 0.96)];
        [phonePath closePath];
...
+ (void)drawCheckinIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Group
    {
        ...
        [bezier2Path moveToPoint: CGPointMake(511.6, 33.2)];
        [bezier2Path addCurveToPoint: CGPointMake(158.1, 386.7) controlPoint1: CGPointMake(316.4, 33.2) controlPoint2: CGPointMake(158.1, 196.8)];
        [bezier2Path addCurveToPoint: CGPointMake(212.8, 575.5) controlPoint1: CGPointMake(158.1, 456.2) controlPoint2: CGPointMake(178.2, 520.9)];
        [bezier2Path addLineToPoint: CGPointMake(511.6, 1004.1)];
        [bezier2Path addLineToPoint: CGPointMake(810.6, 575.2)];
        [bezier2Path addCurveToPoint: CGPointMake(865.1, 386.7) controlPoint1: CGPointMake(845.1, 520.6) controlPoint2: CGPointMake(865.1, 456)];
        [bezier2Path addCurveToPoint: CGPointMake(511.6, 33.2) controlPoint1: CGPointMake(865.1, 191.5) controlPoint2: CGPointMake(706.8, 33.2)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(517.6, 529.7)];
        [bezier2Path addCurveToPoint: CGPointMake(403.1, 415.2) controlPoint1: CGPointMake(454.4, 529.7) controlPoint2: CGPointMake(403.1, 478.4)];
        [bezier2Path addCurveToPoint: CGPointMake(517.6, 300.7) controlPoint1: CGPointMake(403.1, 352) controlPoint2: CGPointMake(454.4, 300.7)];
        [bezier2Path addCurveToPoint: CGPointMake(632.1, 415.2) controlPoint1: CGPointMake(580.8, 300.7) controlPoint2: CGPointMake(632.1, 352)];
        [bezier2Path addCurveToPoint: CGPointMake(517.6, 529.7) controlPoint1: CGPointMake(632, 478.5) controlPoint2: CGPointMake(580.8, 529.7)];
        [bezier2Path closePath];
        [fillColor setStroke];
        bezier2Path.lineWidth = 30;
        [bezier2Path stroke];
...
+ (void)drawCheckinMarkIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(512.17, 4.34)];
        [bezierPath addCurveToPoint: CGPointMake(121.17, 395.34) controlPoint1: CGPointMake(296.27, 4.34) controlPoint2: CGPointMake(121.17, 179.34)];
        [bezierPath addCurveToPoint: CGPointMake(181.67, 604.14) controlPoint1: CGPointMake(121.17, 472.14) controlPoint2: CGPointMake(143.37, 543.74)];
        [bezierPath addLineToPoint: CGPointMake(512.17, 1018.94)];
        [bezierPath addLineToPoint: CGPointMake(842.87, 603.84)];
        [bezierPath addCurveToPoint: CGPointMake(903.17, 395.44) controlPoint1: CGPointMake(880.97, 543.54) controlPoint2: CGPointMake(903.17, 472.04)];
        [bezierPath addCurveToPoint: CGPointMake(512.17, 4.34) controlPoint1: CGPointMake(903.07, 179.44) controlPoint2: CGPointMake(728.07, 4.34)];
        [bezierPath closePath];
        [bezierPath moveToPoint: CGPointMake(436.17, 631.34)];
        [bezierPath addLineToPoint: CGPointMake(284.07, 511.64)];
        [bezierPath addLineToPoint: CGPointMake(342.67, 437.64)];
        [bezierPath addLineToPoint: CGPointMake(430.27, 523.54)];
        [bezierPath addLineToPoint: CGPointMake(665.37, 248.34)];
        [bezierPath addLineToPoint: CGPointMake(791.87, 342.84)];
        [bezierPath addLineToPoint: CGPointMake(436.17, 631.34)];
        [bezierPath closePath];
        [fillColor setFill];
        [bezierPath fill];
        [color setStroke];
...
+ (void)drawSpotIcon2
{
    ...
    UIColor* color4 = [UIColor colorWithRed: 0.878 green: 0.399 blue: 0.148 alpha: 1];
    ...
    //// Group
    {
        //// Group 2
        {
            //// Group 3
            {
                //// Bezier 2 Drawing
                UIBezierPath* bezier2Path = UIBezierPath.bezierPath;
                [bezier2Path moveToPoint: CGPointMake(992.99, 499.93)];
                [bezier2Path addCurveToPoint: CGPointMake(508.49, 984.43) controlPoint1: CGPointMake(992.99, 767.53) controlPoint2: CGPointMake(776.09, 984.43)];
                [bezier2Path addCurveToPoint: CGPointMake(272.59, 923.23) controlPoint1: CGPointMake(422.89, 984.43) controlPoint2: CGPointMake(342.39, 962.23)];
                [bezier2Path addCurveToPoint: CGPointMake(128.99, 984.43) controlPoint1: CGPointMake(253.19, 912.43) controlPoint2: CGPointMake(127.69, 1006.43)];
                [bezier2Path addCurveToPoint: CGPointMake(142.99, 818.03) controlPoint1: CGPointMake(133.99, 904.03) controlPoint2: CGPointMake(165.19, 843.53)];
                [bezier2Path addCurveToPoint: CGPointMake(23.99, 499.93) controlPoint1: CGPointMake(68.89, 732.93) controlPoint2: CGPointMake(23.99, 621.73)];
                [bezier2Path addCurveToPoint: CGPointMake(508.49, 15.43) controlPoint1: CGPointMake(23.99, 232.33) controlPoint2: CGPointMake(240.89, 15.43)];
                [bezier2Path addCurveToPoint: CGPointMake(992.99, 499.93) controlPoint1: CGPointMake(776.09, 15.43) controlPoint2: CGPointMake(992.99, 232.43)];
                [bezier2Path closePath];
                ...
                [bezier4Path moveToPoint: CGPointMake(132.59, 1009.13)];
                [bezier4Path addCurveToPoint: CGPointMake(114.19, 1001.53) controlPoint1: CGPointMake(125.39, 1009.13) controlPoint2: CGPointMake(118.79, 1006.43)];
                [bezier4Path addCurveToPoint: CGPointMake(107.79, 983.13) controlPoint1: CGPointMake(109.59, 996.63) controlPoint2: CGPointMake(107.29, 990.13)];
                [bezier4Path addCurveToPoint: CGPointMake(121.69, 894.23) controlPoint1: CGPointMake(109.89, 949.43) controlPoint2: CGPointMake(116.39, 918.83)];
                [bezier4Path addCurveToPoint: CGPointMake(127.09, 832.13) controlPoint1: CGPointMake(127.19, 868.53) controlPoint2: CGPointMake(133.39, 839.43)];
                [bezier4Path addCurveToPoint: CGPointMake(2.69, 499.93) controlPoint1: CGPointMake(46.89, 740.03) controlPoint2: CGPointMake(2.69, 622.13)];
                [bezier4Path addCurveToPoint: CGPointMake(508.49, -5.87) controlPoint1: CGPointMake(2.69, 221.03) controlPoint2: CGPointMake(229.59, -5.87)];
                [bezier4Path addCurveToPoint: CGPointMake(1014.29, 499.93) controlPoint1: CGPointMake(787.39, -5.87) controlPoint2: CGPointMake(1014.29, 221.03)];
                [bezier4Path addCurveToPoint: CGPointMake(508.49, 1005.73) controlPoint1: CGPointMake(1014.29, 778.83) controlPoint2: CGPointMake(787.39, 1005.73)];
                [bezier4Path addCurveToPoint: CGPointMake(266.29, 944.13) controlPoint1: CGPointMake(423.79, 1005.73) controlPoint2: CGPointMake(340.19, 984.43)];
                [bezier4Path addCurveToPoint: CGPointMake(202.79, 977.03) controlPoint1: CGPointMake(254.39, 947.23) controlPoint2: CGPointMake(222.49, 965.73)];
                [bezier4Path addCurveToPoint: CGPointMake(132.59, 1009.13) controlPoint1: CGPointMake(162.49, 1000.33) controlPoint2: CGPointMake(145.99, 1009.13)];
                [bezier4Path addLineToPoint: CGPointMake(132.59, 1009.13)];
                [bezier4Path closePath];
                [bezier4Path moveToPoint: CGPointMake(268.59, 901.03)];
                [bezier4Path addCurveToPoint: CGPointMake(283.09, 904.63) controlPoint1: CGPointMake(273.99, 901.03) controlPoint2: CGPointMake(278.79, 902.23)];
                [bezier4Path addCurveToPoint: CGPointMake(508.59, 963.13) controlPoint1: CGPointMake(351.59, 942.93) controlPoint2: CGPointMake(429.59, 963.13)];
                [bezier4Path addCurveToPoint: CGPointMake(971.69, 500.03) controlPoint1: CGPointMake(763.99, 963.13) controlPoint2: CGPointMake(971.69, 755.33)];
                [bezier4Path addCurveToPoint: CGPointMake(508.59, 36.93) controlPoint1: CGPointMake(971.69, 244.63) controlPoint2: CGPointMake(763.99, 36.93)];
                [bezier4Path addCurveToPoint: CGPointMake(45.39, 499.93) controlPoint1: CGPointMake(253.19, 36.83) controlPoint2: CGPointMake(45.39, 244.63)];
                [bezier4Path addCurveToPoint: CGPointMake(159.19, 804.03) controlPoint1: CGPointMake(45.39, 611.83) controlPoint2: CGPointMake(85.79, 719.73)];
                [bezier4Path addCurveToPoint: CGPointMake(163.39, 903.13) controlPoint1: CGPointMake(179.59, 827.43) controlPoint2: CGPointMake(172.39, 860.83)];
                [bezier4Path addCurveToPoint: CGPointMake(153.49, 955.93) controlPoint1: CGPointMake(159.89, 919.33) controlPoint2: CGPointMake(156.19, 937.03)];
                [bezier4Path addCurveToPoint: CGPointMake(181.59, 940.03) controlPoint1: CGPointMake(162.79, 950.83) controlPoint2: CGPointMake(173.29, 944.83)];
                [bezier4Path addCurveToPoint: CGPointMake(268.59, 901.03) controlPoint1: CGPointMake(223.49, 915.83) controlPoint2: CGPointMake(250.19, 901.03)];
                [bezier4Path closePath];
    ...
    //// Rectangle 2 Drawing
    CGRect rectangle2Rect = CGRectMake(80.97, 272.18, 1845, 738);
    ...
    NSDictionary* rectangle2FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Helvetica" size: 369], NSForegroundColorAttributeName: color4, NSParagraphStyleAttributeName: rectangle2Style};

    [@"spots" drawInRect: rectangle2Rect withAttributes: rectangle2FontAttributes];
}

+ (void)drawSortArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName rotation: (CGFloat)rotation
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Scaling Group
    {
        ...
        {
            CGContextSaveGState(context);
            CGContextTranslateCTM(context, 512.24, 512.27);
            CGContextRotateCTM(context, -rotation * M_PI / 180);
            ...
            UIBezierPath* arrowPath = UIBezierPath.bezierPath;
            [arrowPath moveToPoint: CGPointMake(31.62, 193.63)];
            [arrowPath addLineToPoint: CGPointMake(486.72, -171.07)];
            [arrowPath addCurveToPoint: CGPointMake(489.62, -197.57) controlPoint1: CGPointMake(494.82, -177.57) controlPoint2: CGPointMake(496.12, -189.47)];
            [arrowPath addLineToPoint: CGPointMake(489.62, -197.57)];
            [arrowPath addCurveToPoint: CGPointMake(463.12, -200.47) controlPoint1: CGPointMake(483.12, -205.67) controlPoint2: CGPointMake(471.22, -206.97)];
            [arrowPath addLineToPoint: CGPointMake(22.22, 152.83)];
            [arrowPath addCurveToPoint: CGPointMake(-0.98, 153.13) controlPoint1: CGPointMake(15.42, 158.23) controlPoint2: CGPointMake(5.92, 158.33)];
            [arrowPath addLineToPoint: CGPointMake(-463.48, -200.47)];
            [arrowPath addCurveToPoint: CGPointMake(-490.18, -196.57) controlPoint1: CGPointMake(-471.88, -206.87) controlPoint2: CGPointMake(-483.98, -205.17)];
            [arrowPath addLineToPoint: CGPointMake(-490.18, -196.57)];
            [arrowPath addCurveToPoint: CGPointMake(-486.38, -170.57) controlPoint1: CGPointMake(-496.18, -188.27) controlPoint2: CGPointMake(-494.48, -176.77)];
            [arrowPath addLineToPoint: CGPointMake(-4.38, 197.63)];
            [arrowPath addLineToPoint: CGPointMake(0.32, 201.03)];
            [arrowPath addCurveToPoint: CGPointMake(23.12, 200.43) controlPoint1: CGPointMake(7.22, 206.03) controlPoint2: CGPointMake(16.52, 205.73)];
            [arrowPath addLineToPoint: CGPointMake(31.62, 193.63)];
            [arrowPath closePath];
...
+ (void)drawMapBubblePinFilledIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY
{
    ...
    PCGradient* myMapPinGradient = [PCGradient gradientWithColors: @[myMapGradient1, myMapGradient2, myMapGradient3] locations: myMapPinGradientLocations];
    CGFloat myMapPinShadowLocations[] = {0, 0.51, 1};
    PCGradient* myMapPinShadow = [PCGradient gradientWithColors: @[myMapPinShadow1, myMapPinShadow2, myMapPinShadow1] locations: myMapPinShadowLocations];
    ...
    //// Group
    {
        ...
        CGContextSaveGState(context);
        [shadowPath addClip];
        CGContextDrawLinearGradient(context, myMapPinShadow.CGGradient,
        ...
        CGContextSaveGState(context);
        [bubblePath addClip];
        CGContextDrawLinearGradient(context, myMapPinGradient.CGGradient,
...
+ (void)drawGradientBackgroundWithWidth: (CGFloat)width height: (CGFloat)height scaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY
{
    ...
    PCGradient* myTintColorGradient = [PCGradient gradientWithColors: @[myTintColorGradientColor1, myTintColorGradientColor2] locations: myTintColorGradientLocations];
    ...
    //// Group
    {
        ...
        //// Rectangle Drawing
        CGRect rectangleRect = CGRectMake(0, 0, width, height);
        UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: rectangleRect];
        CGContextSaveGState(context);
        [rectanglePath addClip];
        CGContextDrawLinearGradient(context, myTintColorGradient.CGGradient,
...
+ (void)drawTopBarWhiteShadowBackground
{
    ...
    //// Group
    {
        ...
        CGContextSaveGState(context);
        [rectanglePath addClip];
        CGContextDrawLinearGradient(context, SHStyleKit.myWhiteShadowGradient.CGGradient, CGPointMake(160, -0), CGPointMake(160, 64), 0);
        CGContextRestoreGState(context);
    }
}
...
+ (void)drawBottomBarBlackShadowBackground
{
    ...
    CGContextSaveGState(context);
    [rectanglePath addClip];
    CGContextDrawLinearGradient(context, SHStyleKit.myDarkShadowGradient.CGGradient, CGPointMake(160, 64), CGPointMake(160, -0), 0);
    CGContextRestoreGState(context);
}
...
+ (void)drawTopShadow
{
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, 320, 10)];
    CGContextSaveGState(context);
    [rectanglePath addClip];
    CGContextDrawLinearGradient(context, SHStyleKit.myLightShadowGradient.CGGradient, CGPointMake(160, 10), CGPointMake(160, -0), 0);
    CGContextRestoreGState(context);
}
...
+ (void)drawRatingSwooshWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName fillColorName: (NSString*)fillColorName percentage: (CGFloat)percentage
{
    ...
    UIColor* strokeColor = [strokeColorName isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([strokeColorName isEqualToString: @"myTintTransparentColor"] ? SHStyleKit.myTintTransparentColor : ([strokeColorName isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([strokeColorName isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([strokeColorName isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([strokeColorName isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([strokeColorName isEqualToString: @"myBlackColor"] ? SHStyleKit.myBlackColor : ([strokeColorName isEqualToString: @"default"] ? SHStyleKit.myWhiteColor : SHStyleKit.myClearColor)))))));
    UIColor* fillColor = [fillColorName isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([fillColorName isEqualToString: @"myTintTransparentColor"] ? SHStyleKit.myTintTransparentColor : ([fillColorName isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([fillColorName isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([fillColorName isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([fillColorName isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([fillColorName isEqualToString: @"myBlackColor"] ? SHStyleKit.myBlackColor : ([fillColorName isEqualToString: @"default"] ? SHStyleKit.myWhiteColor : SHStyleKit.myClearColor)))))));
    CGFloat calculatedSwooshPosition = 1547 * (percentage / 100.0) - 792;
    ...
    //// Main Group
    {
        ...
        //// Group
        {
            ...
            //// Clip Swoosh
            UIBezierPath* swooshPath = UIBezierPath.bezierPath;
            [swooshPath moveToPoint: CGPointMake(8.98, 687.27)];
            [swooshPath addCurveToPoint: CGPointMake(1024.08, 546.57) controlPoint1: CGPointMake(320.68, 79.47) controlPoint2: CGPointMake(856.38, 301.07)];
            [swooshPath addLineToPoint: CGPointMake(909.78, 687.27)];
            [swooshPath addCurveToPoint: CGPointMake(8.98, 687.27) controlPoint1: CGPointMake(680.98, 215.37) controlPoint2: CGPointMake(277.78, 342.07)];
            [swooshPath closePath];
            swooshPath.miterLimit = 4;

            [swooshPath addClip];


            //// Background Drawing
            UIBezierPath* backgroundPath = [UIBezierPath bezierPathWithRect: CGRectMake(0.5, 296.5, 1023, 389)];
            [fillColor setFill];
            [backgroundPath fill];
            ...
            //// Fill Bezier Drawing
            UIBezierPath* fillBezierPath = UIBezierPath.bezierPath;
            [fillBezierPath moveToPoint: CGPointMake(-601.5, 250.5)];
            [fillBezierPath addLineToPoint: CGPointMake(407.5, 1309.5)];
            [fillBezierPath addLineToPoint: CGPointMake((calculatedSwooshPosition + 512), 250.5)];
            [fillBezierPath addLineToPoint: CGPointMake(-601.5, 250.5)];
            [fillBezierPath closePath];
            [strokeColor setFill];
            [fillBezierPath fill];
            [UIColor.blackColor setStroke];
            fillBezierPath.lineWidth = 1;
            [fillBezierPath stroke];
...
+ (void)drawRatingStarsWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName percentage: (CGFloat)percentage
{
    ...
    //// Variable Declarations
    UIColor* fillColor = [fillColorName isEqualToString: @"myTintColor"] ? SHStyleKit.myTintColor : ([fillColorName isEqualToString: @"myTintTransparentColor"] ? SHStyleKit.myTintTransparentColor : ([fillColorName isEqualToString: @"myTextTransparentColor"] ? SHStyleKit.myTextTransparentColor : ([fillColorName isEqualToString: @"myTextColor"] ? SHStyleKit.myTextColor : ([fillColorName isEqualToString: @"myWhiteColor"] ? SHStyleKit.myWhiteColor : ([fillColorName isEqualToString: @"myWhiteTransparentColor"] ? SHStyleKit.myWhiteTransparentColor : ([fillColorName isEqualToString: @"myBlackColor"] ? SHStyleKit.myBlackColor : ([fillColorName isEqualToString: @"default"] ? SHStyleKit.myWhiteColor : SHStyleKit.myClearColor)))))));
    CGFloat starsForegroundWidth = 5200 * (percentage / 100.0);
    ...
    //// Group
    {
        ...
        [starsPath moveToPoint: CGPointMake(520.05, 0)];
        [starsPath addLineToPoint: CGPointMake(674.46, 329.14)];
        [starsPath addLineToPoint: CGPointMake(1020, 381.96)];
        [starsPath addLineToPoint: CGPointMake(769.98, 638.21)];
        [starsPath addLineToPoint: CGPointMake(828.98, 1000)];
        [starsPath addLineToPoint: CGPointMake(520.05, 829.24)];
        [starsPath addLineToPoint: CGPointMake(211.02, 1000)];
        [starsPath addLineToPoint: CGPointMake(270.02, 638.21)];
        [starsPath addLineToPoint: CGPointMake(20, 381.96)];
        [starsPath addLineToPoint: CGPointMake(365.54, 329.14)];
        [starsPath addLineToPoint: CGPointMake(520.05, 0)];
        [starsPath closePath];
        [starsPath moveToPoint: CGPointMake(1560.05, 0)];
        [starsPath addLineToPoint: CGPointMake(1714.46, 329.14)];
        [starsPath addLineToPoint: CGPointMake(2060, 381.96)];
        [starsPath addLineToPoint: CGPointMake(1809.98, 638.21)];
        [starsPath addLineToPoint: CGPointMake(1868.98, 1000)];
        [starsPath addLineToPoint: CGPointMake(1560.05, 829.24)];
        [starsPath addLineToPoint: CGPointMake(1251.02, 1000)];
        [starsPath addLineToPoint: CGPointMake(1310.02, 638.21)];
        [starsPath addLineToPoint: CGPointMake(1060, 381.96)];
        [starsPath addLineToPoint: CGPointMake(1405.54, 329.14)];
        [starsPath addLineToPoint: CGPointMake(1560.05, 0)];
        [starsPath closePath];
        [starsPath moveToPoint: CGPointMake(2600.05, 0)];
        [starsPath addLineToPoint: CGPointMake(2754.46, 329.14)];
        [starsPath addLineToPoint: CGPointMake(3100, 381.96)];
        [starsPath addLineToPoint: CGPointMake(2849.98, 638.21)];
        [starsPath addLineToPoint: CGPointMake(2908.98, 1000)];
        [starsPath addLineToPoint: CGPointMake(2600.05, 829.24)];
        [starsPath addLineToPoint: CGPointMake(2291.02, 1000)];
        [starsPath addLineToPoint: CGPointMake(2350.02, 638.21)];
        [starsPath addLineToPoint: CGPointMake(2100, 381.96)];
        [starsPath addLineToPoint: CGPointMake(2445.54, 329.14)];
        [starsPath addLineToPoint: CGPointMake(2600.05, 0)];
        [starsPath closePath];
        [starsPath moveToPoint: CGPointMake(3640.05, 0)];
        [starsPath addLineToPoint: CGPointMake(3794.46, 329.14)];
        [starsPath addLineToPoint: CGPointMake(4140, 381.96)];
        [starsPath addLineToPoint: CGPointMake(3889.98, 638.21)];
        [starsPath addLineToPoint: CGPointMake(3948.98, 1000)];
        [starsPath addLineToPoint: CGPointMake(3640.05, 829.24)];
        [starsPath addLineToPoint: CGPointMake(3331.02, 1000)];
        [starsPath addLineToPoint: CGPointMake(3390.02, 638.21)];
        [starsPath addLineToPoint: CGPointMake(3140, 381.96)];
        [starsPath addLineToPoint: CGPointMake(3485.54, 329.14)];
        [starsPath addLineToPoint: CGPointMake(3640.05, 0)];
        [starsPath closePath];
        [starsPath moveToPoint: CGPointMake(4680.05, 0)];
        [starsPath addLineToPoint: CGPointMake(4834.46, 329.14)];
        [starsPath addLineToPoint: CGPointMake(5180, 381.96)];
        [starsPath addLineToPoint: CGPointMake(4929.98, 638.21)];
        [starsPath addLineToPoint: CGPointMake(4988.98, 1000)];
        [starsPath addLineToPoint: CGPointMake(4680.05, 829.24)];
        [starsPath addLineToPoint: CGPointMake(4371.02, 1000)];
        [starsPath addLineToPoint: CGPointMake(4430.02, 638.21)];
        [starsPath addLineToPoint: CGPointMake(4180, 381.96)];
        [starsPath addLineToPoint: CGPointMake(4525.54, 329.14)];
        [starsPath addLineToPoint: CGPointMake(4680.05, 0)];
        [starsPath closePath];
        [starsPath addClip];


        //// Background Drawing
        UIBezierPath* backgroundPath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, 5200, 1000)];
        [SHStyleKit.myTextTransparentColor setFill];
        [backgroundPath fill];


        //// Foreground Drawing
        UIBezierPath* foregroundPath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, starsForegroundWidth, 1000)];
        [fillColor setFill];
        [foregroundPath fill];
...
+ (UIImage*)imageOfNavigationArrowIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY fillColorName: (NSString*)fillColorName rotation: (CGFloat)rotation
{
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(1024, 1024), NO, 0.0f);
    [SHStyleKit drawNavigationArrowIconWithScaleX: scaleX scaleY: scaleY fillColorName: fillColorName rotation: rotation];
