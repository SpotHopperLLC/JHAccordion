...
//  SpotHopper
//
//  Created by SpotHopper on 6/11/14.
...
+ (void)drawFillerUpIcon;
{
    ...
    //// Group 2
    {
        ...
        [glassBezierPath moveToPoint: CGPointMake(251.28, 0)];
        [glassBezierPath addCurveToPoint: CGPointMake(737.68, 0) controlPoint1: CGPointMake(251.28, 0) controlPoint2: CGPointMake(737.68, 0)];
        [glassBezierPath addLineToPoint: CGPointMake(741.98, 15.6)];
        [glassBezierPath addCurveToPoint: CGPointMake(718.88, 436.5) controlPoint1: CGPointMake(798.78, 223.5) controlPoint2: CGPointMake(759.98, 327)];
        [glassBezierPath addCurveToPoint: CGPointMake(686.08, 995.1) controlPoint1: CGPointMake(674.48, 554.9) controlPoint2: CGPointMake(624.08, 689.1)];
        [glassBezierPath addLineToPoint: CGPointMake(691.18, 1020.5)];
        [glassBezierPath addLineToPoint: CGPointMake(302.18, 1020.5)];
        [glassBezierPath addLineToPoint: CGPointMake(307.28, 995.2)];
        [glassBezierPath addCurveToPoint: CGPointMake(261.98, 450) controlPoint1: CGPointMake(365.48, 702) controlPoint2: CGPointMake(310.48, 568.1)];
        [glassBezierPath addCurveToPoint: CGPointMake(246.28, 14.2) controlPoint1: CGPointMake(215.38, 336.5) controlPoint2: CGPointMake(171.38, 229.4)];
        [glassBezierPath addLineToPoint: CGPointMake(251.28, 0)];
        [glassBezierPath addLineToPoint: CGPointMake(251.28, 0)];
        [glassBezierPath closePath];
        [SHStyleKit.myTintColorDesaturated setFill];
        [glassBezierPath fill];
        ...
        //// Group
        {
            ...
            [fillBezierPath moveToPoint: CGPointMake(691.18, 1020.5)];
            [fillBezierPath addLineToPoint: CGPointMake(302.18, 1020.5)];
            [fillBezierPath addLineToPoint: CGPointMake(307.28, 995.2)];
            [fillBezierPath addCurveToPoint: CGPointMake(261.98, 450) controlPoint1: CGPointMake(365.48, 702) controlPoint2: CGPointMake(310.48, 568.1)];
            [fillBezierPath addCurveToPoint: CGPointMake(246.28, 14.2) controlPoint1: CGPointMake(215.38, 336.5) controlPoint2: CGPointMake(171.38, 229.4)];
            [fillBezierPath addLineToPoint: CGPointMake(251.28, 0)];
            [fillBezierPath addLineToPoint: CGPointMake(737.68, 0)];
            [fillBezierPath addLineToPoint: CGPointMake(741.98, 15.6)];
            [fillBezierPath addCurveToPoint: CGPointMake(718.88, 436.5) controlPoint1: CGPointMake(798.78, 223.5) controlPoint2: CGPointMake(759.98, 327)];
            [fillBezierPath addCurveToPoint: CGPointMake(686.08, 995.1) controlPoint1: CGPointMake(674.48, 554.9) controlPoint2: CGPointMake(624.08, 689.1)];
            [fillBezierPath addLineToPoint: CGPointMake(691.18, 1020.5)];
            [fillBezierPath closePath];
            [fillBezierPath moveToPoint: CGPointMake(353.58, 978.1)];
            [fillBezierPath addLineToPoint: CGPointMake(639.48, 978.1)];
            [fillBezierPath addCurveToPoint: CGPointMake(679.08, 421.6) controlPoint1: CGPointMake(582.88, 678) controlPoint2: CGPointMake(633.98, 542)];
            [fillBezierPath addCurveToPoint: CGPointMake(705.08, 42.4) controlPoint1: CGPointMake(718.28, 317.2) controlPoint2: CGPointMake(752.28, 226.6)];
            [fillBezierPath addLineToPoint: CGPointMake(281.48, 42.4)];
            [fillBezierPath addCurveToPoint: CGPointMake(301.18, 433.9) controlPoint1: CGPointMake(218.48, 232.5) controlPoint2: CGPointMake(255.08, 321.7)];
            [fillBezierPath addCurveToPoint: CGPointMake(353.58, 978.1) controlPoint1: CGPointMake(350.48, 554.1) controlPoint2: CGPointMake(406.28, 689.8)];
            [fillBezierPath closePath];
            fillBezierPath.miterLimit = 4;
