...
//  SpotHopper
//
//  Created by SpotHopper on 8/17/14.
...
static UIColor* _myBlackTransparent = nil;
...
+ (void)initialize
{
    ...
    _myBlackTransparent = [SHStyleKit.myBlackColor colorWithAlphaComponent: 0.75];
...
+ (UIColor*)myBlackTransparent { return _myBlackTransparent; }
...
+ (void)drawSimilarWineIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        [bezier2Path moveToPoint: CGPointMake(944, 80)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 160) controlPoint1: CGPointMake(944, 80) controlPoint2: CGPointMake(944, 160)];
        [bezier2Path addLineToPoint: CGPointMake(769.5, 160)];
        [bezier2Path addCurveToPoint: CGPointMake(772.85, 80) controlPoint1: CGPointMake(771.34, 134.72) controlPoint2: CGPointMake(772.45, 108.06)];
        [bezier2Path addLineToPoint: CGPointMake(944, 80)];
        [bezier2Path addLineToPoint: CGPointMake(944, 80)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 220)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 300) controlPoint1: CGPointMake(944, 220) controlPoint2: CGPointMake(944, 300)];
        [bezier2Path addLineToPoint: CGPointMake(748.67, 300)];
        [bezier2Path addCurveToPoint: CGPointMake(763.46, 220) controlPoint1: CGPointMake(754.74, 275.43) controlPoint2: CGPointMake(759.67, 248.78)];
        [bezier2Path addLineToPoint: CGPointMake(944, 220)];
        [bezier2Path addLineToPoint: CGPointMake(944, 220)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 360)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 440) controlPoint1: CGPointMake(944, 360) controlPoint2: CGPointMake(944, 440)];
        [bezier2Path addLineToPoint: CGPointMake(686.24, 440)];
        [bezier2Path addCurveToPoint: CGPointMake(730.01, 360) controlPoint1: CGPointMake(703.4, 417.77) controlPoint2: CGPointMake(717.98, 391.15)];
        [bezier2Path addLineToPoint: CGPointMake(944, 360)];
        [bezier2Path addLineToPoint: CGPointMake(944, 360)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 500)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 580) controlPoint1: CGPointMake(944, 500) controlPoint2: CGPointMake(944, 580)];
        [bezier2Path addLineToPoint: CGPointMake(539.6, 580)];
        [bezier2Path addCurveToPoint: CGPointMake(539.6, 521.06) controlPoint1: CGPointMake(539.6, 544.94) controlPoint2: CGPointMake(539.6, 521.06)];
        [bezier2Path addCurveToPoint: CGPointMake(615.02, 500) controlPoint1: CGPointMake(566.99, 518.58) controlPoint2: CGPointMake(592.18, 511.54)];
        [bezier2Path addLineToPoint: CGPointMake(944, 500)];
        [bezier2Path addLineToPoint: CGPointMake(944, 500)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(539.6, 640)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 640) controlPoint1: CGPointMake(539.6, 640) controlPoint2: CGPointMake(944, 640)];
        [bezier2Path addLineToPoint: CGPointMake(944, 720)];
        [bezier2Path addLineToPoint: CGPointMake(539.6, 720)];
        [bezier2Path addCurveToPoint: CGPointMake(539.6, 640) controlPoint1: CGPointMake(539.6, 693.44) controlPoint2: CGPointMake(539.6, 665.86)];
        [bezier2Path addLineToPoint: CGPointMake(539.6, 640)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 770)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 850) controlPoint1: CGPointMake(944, 770) controlPoint2: CGPointMake(944, 850)];
        [bezier2Path addLineToPoint: CGPointMake(539.6, 850)];
        [bezier2Path addCurveToPoint: CGPointMake(539.6, 770) controlPoint1: CGPointMake(539.6, 835.86) controlPoint2: CGPointMake(539.6, 806.1)];
        [bezier2Path addLineToPoint: CGPointMake(944, 770)];
        [bezier2Path addLineToPoint: CGPointMake(944, 770)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(150.45, 212.29)];
        [bezier2Path addLineToPoint: CGPointMake(624.45, 212.29)];
        [bezier2Path addLineToPoint: CGPointMake(150.45, 212.29)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(597.35, 59.89)];
        [bezier2Path addLineToPoint: CGPointMake(162.35, 59.89)];
        [bezier2Path addCurveToPoint: CGPointMake(178.06, 198.77) controlPoint1: CGPointMake(165.42, 110.88) controlPoint2: CGPointMake(170.67, 157.18)];
        [bezier2Path addLineToPoint: CGPointMake(590.38, 198.77)];
        [bezier2Path addCurveToPoint: CGPointMake(597.35, 59.89) controlPoint1: CGPointMake(595.02, 157.13) controlPoint2: CGPointMake(597.35, 110.81)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(586.96, 225.71)];
        [bezier2Path addLineToPoint: CGPointMake(183.3, 225.71)];
        [bezier2Path addCurveToPoint: CGPointMake(391.65, 471.97) controlPoint1: CGPointMake(217.33, 386.73) controlPoint2: CGPointMake(287.08, 469.37)];
        [bezier2Path addCurveToPoint: CGPointMake(506.05, 429.02) controlPoint1: CGPointMake(438.45, 472.97) controlPoint2: CGPointMake(475.95, 458.75)];
        [bezier2Path addCurveToPoint: CGPointMake(586.96, 225.71) controlPoint1: CGPointMake(546.27, 389.17) controlPoint2: CGPointMake(573.32, 321.07)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(388.85, 921.24)];
        [bezier2Path addCurveToPoint: CGPointMake(336.15, 969.95) controlPoint1: CGPointMake(374.25, 939.43) controlPoint2: CGPointMake(356.65, 955.74)];
        [bezier2Path addLineToPoint: CGPointMake(437.75, 969.95)];
        [bezier2Path addCurveToPoint: CGPointMake(388.85, 921.24) controlPoint1: CGPointMake(418.05, 955.74) controlPoint2: CGPointMake(401.75, 939.43)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(650.95, 5.9)];
        [bezier2Path addCurveToPoint: CGPointMake(651.35, 32.45) controlPoint1: CGPointMake(650.95, 5.9) controlPoint2: CGPointMake(651.35, 32.45)];
        [bezier2Path addCurveToPoint: CGPointMake(544.25, 467.2) controlPoint1: CGPointMake(654.65, 250.37) controlPoint2: CGPointMake(619.65, 392.54)];
        [bezier2Path addCurveToPoint: CGPointMake(418.15, 524.96) controlPoint1: CGPointMake(509.95, 501.1) controlPoint2: CGPointMake(467.65, 520.49)];
        [bezier2Path addLineToPoint: CGPointMake(418.15, 862.78)];
        [bezier2Path addCurveToPoint: CGPointMake(531.45, 958.32) controlPoint1: CGPointMake(435.15, 905.23) controlPoint2: CGPointMake(472.25, 936.55)];
        [bezier2Path addCurveToPoint: CGPointMake(553.25, 996.1) controlPoint1: CGPointMake(546.95, 964.09) controlPoint2: CGPointMake(556.15, 979.99)];
        [bezier2Path addCurveToPoint: CGPointMake(519.75, 1023.94) controlPoint1: CGPointMake(550.35, 1012.21) controlPoint2: CGPointMake(536.25, 1023.94)];
        [bezier2Path addLineToPoint: CGPointMake(247.05, 1023.94)];
        [bezier2Path addCurveToPoint: CGPointMake(214.65, 996.9) controlPoint1: CGPointMake(231.05, 1023.94) controlPoint2: CGPointMake(217.45, 1012.6)];
        [bezier2Path addCurveToPoint: CGPointMake(235.85, 960.51) controlPoint1: CGPointMake(211.85, 981.19) controlPoint2: CGPointMake(220.85, 965.88)];
        [bezier2Path addCurveToPoint: CGPointMake(363.95, 861.29) controlPoint1: CGPointMake(298.25, 938.14) controlPoint2: CGPointMake(340.25, 905.63)];
        [bezier2Path addLineToPoint: CGPointMake(363.95, 523.87)];
        [bezier2Path addCurveToPoint: CGPointMake(106.75, 34.04) controlPoint1: CGPointMake(206.55, 504.08) controlPoint2: CGPointMake(120.05, 339.45)];
        [bezier2Path addLineToPoint: CGPointMake(105.55, 5.9)];
        [bezier2Path addLineToPoint: CGPointMake(650.95, 5.9)];
        [bezier2Path addLineToPoint: CGPointMake(650.95, 5.9)];
        [bezier2Path closePath];
        [strokeColor setFill];
        [bezier2Path fill];
...
+ (void)drawSimilarCocktailIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier 2 Drawing
        UIBezierPath* bezier2Path = UIBezierPath.bezierPath;
        [bezier2Path moveToPoint: CGPointMake(786.88, 80)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 80) controlPoint1: CGPointMake(786.88, 80) controlPoint2: CGPointMake(944, 80)];
        [bezier2Path addLineToPoint: CGPointMake(944, 160)];
        [bezier2Path addLineToPoint: CGPointMake(707.08, 160)];
        [bezier2Path addCurveToPoint: CGPointMake(719.6, 146.96) controlPoint1: CGPointMake(714.32, 152.46) controlPoint2: CGPointMake(719.6, 146.96)];
        [bezier2Path addCurveToPoint: CGPointMake(771.8, 132.17) controlPoint1: CGPointMake(736.6, 151.85) controlPoint2: CGPointMake(757, 146.86)];
        [bezier2Path addCurveToPoint: CGPointMake(786.88, 80) controlPoint1: CGPointMake(786.48, 117.41) controlPoint2: CGPointMake(791.71, 97.1)];
        [bezier2Path addLineToPoint: CGPointMake(786.88, 80)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(852.32, 220)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 220) controlPoint1: CGPointMake(852.31, 220) controlPoint2: CGPointMake(944, 220)];
        [bezier2Path addLineToPoint: CGPointMake(944, 300)];
        [bezier2Path addLineToPoint: CGPointMake(775.59, 300)];
        [bezier2Path addCurveToPoint: CGPointMake(852.31, 220) controlPoint1: CGPointMake(808.23, 265.97) controlPoint2: CGPointMake(835.77, 237.25)];
        [bezier2Path addLineToPoint: CGPointMake(852.32, 220)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(718.05, 360)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 360) controlPoint1: CGPointMake(718.05, 360) controlPoint2: CGPointMake(944, 360)];
        [bezier2Path addLineToPoint: CGPointMake(944, 440)];
        [bezier2Path addLineToPoint: CGPointMake(641.33, 440)];
        [bezier2Path addCurveToPoint: CGPointMake(718.05, 360) controlPoint1: CGPointMake(666.46, 413.79) controlPoint2: CGPointMake(692.7, 386.43)];
        [bezier2Path addLineToPoint: CGPointMake(718.05, 360)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 500)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 580) controlPoint1: CGPointMake(944, 500) controlPoint2: CGPointMake(944, 580)];
        [bezier2Path addLineToPoint: CGPointMake(507.06, 580)];
        [bezier2Path addCurveToPoint: CGPointMake(583.78, 500) controlPoint1: CGPointMake(520.52, 565.97) controlPoint2: CGPointMake(548.74, 536.53)];
        [bezier2Path addLineToPoint: CGPointMake(944, 500)];
        [bezier2Path addLineToPoint: CGPointMake(944, 500)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(498.6, 640)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 640) controlPoint1: CGPointMake(498.6, 640) controlPoint2: CGPointMake(944, 640)];
        [bezier2Path addLineToPoint: CGPointMake(944, 720)];
        [bezier2Path addLineToPoint: CGPointMake(498.6, 720)];
        [bezier2Path addCurveToPoint: CGPointMake(498.6, 640) controlPoint1: CGPointMake(498.6, 690.54) controlPoint2: CGPointMake(498.6, 662.52)];
        [bezier2Path addLineToPoint: CGPointMake(498.6, 640)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 770)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 850) controlPoint1: CGPointMake(944, 770) controlPoint2: CGPointMake(944, 850)];
        [bezier2Path addLineToPoint: CGPointMake(498.6, 850)];
        [bezier2Path addCurveToPoint: CGPointMake(498.6, 770) controlPoint1: CGPointMake(498.6, 826.51) controlPoint2: CGPointMake(498.6, 798.64)];
        [bezier2Path addLineToPoint: CGPointMake(944, 770)];
        [bezier2Path addLineToPoint: CGPointMake(944, 770)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(418.5, 588.92)];
        [bezier2Path addLineToPoint: CGPointMake(789, 202.6)];
        [bezier2Path addLineToPoint: CGPointMake(586.2, 202.6)];
        [bezier2Path addLineToPoint: CGPointMake(639.6, 146.96)];
        [bezier2Path addCurveToPoint: CGPointMake(691.8, 132.17) controlPoint1: CGPointMake(656.6, 151.85) controlPoint2: CGPointMake(677, 146.86)];
        [bezier2Path addCurveToPoint: CGPointMake(706.1, 77.52) controlPoint1: CGPointMake(707.2, 116.69) controlPoint2: CGPointMake(712.2, 95.11)];
        [bezier2Path addLineToPoint: CGPointMake(759.3, 21.98)];
        [bezier2Path addLineToPoint: CGPointMake(736.1, 0)];
        [bezier2Path addLineToPoint: CGPointMake(684.6, 53.75)];
        [bezier2Path addCurveToPoint: CGPointMake(625.5, 65.84) controlPoint1: CGPointMake(666.4, 44.86) controlPoint2: CGPointMake(642.4, 48.95)];
        [bezier2Path addCurveToPoint: CGPointMake(614.3, 127.08) controlPoint1: CGPointMake(608, 83.42) controlPoint2: CGPointMake(604.1, 108.69)];
        [bezier2Path addLineToPoint: CGPointMake(542, 202.6)];
        [bezier2Path addLineToPoint: CGPointMake(0, 202.6)];
        [bezier2Path addLineToPoint: CGPointMake(370.6, 588.92)];
        [bezier2Path addLineToPoint: CGPointMake(370.6, 914.31)];
        [bezier2Path addLineToPoint: CGPointMake(191.6, 991.93)];
        [bezier2Path addCurveToPoint: CGPointMake(597.6, 991.93) controlPoint1: CGPointMake(191.6, 991.93) controlPoint2: CGPointMake(393.5, 1063.76)];
        [bezier2Path addLineToPoint: CGPointMake(418.6, 914.31)];
        [bezier2Path addLineToPoint: CGPointMake(418.6, 588.92)];
        [bezier2Path addLineToPoint: CGPointMake(418.5, 588.92)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(448.1, 300.41)];
        [bezier2Path addLineToPoint: CGPointMake(368.8, 383.23)];
        [bezier2Path addLineToPoint: CGPointMake(391.8, 405.3)];
        [bezier2Path addLineToPoint: CGPointMake(492.4, 300.51)];
        [bezier2Path addLineToPoint: CGPointMake(634.1, 300.51)];
        [bezier2Path addLineToPoint: CGPointMake(394.6, 550.06)];
        [bezier2Path addLineToPoint: CGPointMake(155.1, 300.41)];
        [bezier2Path addLineToPoint: CGPointMake(448.1, 300.41)];
        [bezier2Path closePath];
        [strokeColor setFill];
        [bezier2Path fill];
...
+ (void)drawSimilarBeerIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        [bezier2Path moveToPoint: CGPointMake(944, 80)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 160) controlPoint1: CGPointMake(944, 80) controlPoint2: CGPointMake(944, 160)];
        [bezier2Path addLineToPoint: CGPointMake(721.27, 160)];
        [bezier2Path addCurveToPoint: CGPointMake(709.64, 80) controlPoint1: CGPointMake(719.19, 135.25) controlPoint2: CGPointMake(715.43, 108.72)];
        [bezier2Path addLineToPoint: CGPointMake(944, 80)];
        [bezier2Path addLineToPoint: CGPointMake(944, 80)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 220)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 300) controlPoint1: CGPointMake(944, 220) controlPoint2: CGPointMake(944, 300)];
        [bezier2Path addLineToPoint: CGPointMake(714.4, 300)];
        [bezier2Path addCurveToPoint: CGPointMake(723.1, 220) controlPoint1: CGPointMake(719.2, 275.22) controlPoint2: CGPointMake(722.35, 248.86)];
        [bezier2Path addLineToPoint: CGPointMake(944, 220)];
        [bezier2Path addLineToPoint: CGPointMake(944, 220)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(944, 360)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 440) controlPoint1: CGPointMake(944, 360) controlPoint2: CGPointMake(944, 440)];
        [bezier2Path addLineToPoint: CGPointMake(670.92, 440)];
        [bezier2Path addLineToPoint: CGPointMake(671.64, 438.07)];
        [bezier2Path addCurveToPoint: CGPointMake(699.19, 360) controlPoint1: CGPointMake(681.36, 412.2) controlPoint2: CGPointMake(690.96, 386.66)];
        [bezier2Path addLineToPoint: CGPointMake(944, 360)];
        [bezier2Path addLineToPoint: CGPointMake(944, 360)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(649.24, 500)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 500) controlPoint1: CGPointMake(649.24, 500) controlPoint2: CGPointMake(944, 500)];
        [bezier2Path addLineToPoint: CGPointMake(944, 580)];
        [bezier2Path addLineToPoint: CGPointMake(626.71, 580)];
        [bezier2Path addCurveToPoint: CGPointMake(649.24, 500) controlPoint1: CGPointMake(633.13, 551.02) controlPoint2: CGPointMake(640.93, 524.72)];
        [bezier2Path addLineToPoint: CGPointMake(649.24, 500)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(616.2, 640)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 640) controlPoint1: CGPointMake(616.2, 640) controlPoint2: CGPointMake(944, 640)];
        [bezier2Path addLineToPoint: CGPointMake(944, 720)];
        [bezier2Path addLineToPoint: CGPointMake(610.17, 720)];
        [bezier2Path addCurveToPoint: CGPointMake(616.2, 640) controlPoint1: CGPointMake(610.87, 691.11) controlPoint2: CGPointMake(613, 664.6)];
        [bezier2Path addLineToPoint: CGPointMake(616.2, 640)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(610.39, 770)];
        [bezier2Path addCurveToPoint: CGPointMake(944, 770) controlPoint1: CGPointMake(610.38, 770) controlPoint2: CGPointMake(944, 770)];
        [bezier2Path addLineToPoint: CGPointMake(944, 850)];
        [bezier2Path addLineToPoint: CGPointMake(615.93, 850)];
        [bezier2Path addCurveToPoint: CGPointMake(610.38, 770) controlPoint1: CGPointMake(612.95, 821.54) controlPoint2: CGPointMake(611.16, 794.95)];
        [bezier2Path addLineToPoint: CGPointMake(610.39, 770)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(442.7, 717.47)];
        [bezier2Path addCurveToPoint: CGPointMake(442.7, 738.1) controlPoint1: CGPointMake(448.4, 723.17) controlPoint2: CGPointMake(448.4, 732.4)];
        [bezier2Path addCurveToPoint: CGPointMake(422.05, 738.1) controlPoint1: CGPointMake(437, 743.8) controlPoint2: CGPointMake(427.76, 743.8)];
        [bezier2Path addCurveToPoint: CGPointMake(422.05, 717.47) controlPoint1: CGPointMake(416.35, 732.4) controlPoint2: CGPointMake(416.35, 723.17)];
        [bezier2Path addCurveToPoint: CGPointMake(442.7, 717.47) controlPoint1: CGPointMake(427.76, 711.78) controlPoint2: CGPointMake(437, 711.78)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(477.11, 571.11)];
        [bezier2Path addCurveToPoint: CGPointMake(477.11, 590.75) controlPoint1: CGPointMake(482.54, 576.53) controlPoint2: CGPointMake(482.54, 585.33)];
        [bezier2Path addCurveToPoint: CGPointMake(457.45, 590.75) controlPoint1: CGPointMake(471.68, 596.17) controlPoint2: CGPointMake(462.88, 596.17)];
        [bezier2Path addCurveToPoint: CGPointMake(457.45, 571.11) controlPoint1: CGPointMake(452.02, 585.33) controlPoint2: CGPointMake(452.02, 576.53)];
        [bezier2Path addCurveToPoint: CGPointMake(477.11, 571.11) controlPoint1: CGPointMake(462.88, 565.69) controlPoint2: CGPointMake(471.68, 565.69)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(420.88, 450.06)];
        [bezier2Path addCurveToPoint: CGPointMake(420.88, 466.44) controlPoint1: CGPointMake(425.41, 454.58) controlPoint2: CGPointMake(425.41, 461.92)];
        [bezier2Path addCurveToPoint: CGPointMake(404.48, 466.44) controlPoint1: CGPointMake(416.35, 470.97) controlPoint2: CGPointMake(409.01, 470.97)];
        [bezier2Path addCurveToPoint: CGPointMake(404.48, 450.06) controlPoint1: CGPointMake(399.95, 461.92) controlPoint2: CGPointMake(399.95, 454.58)];
        [bezier2Path addCurveToPoint: CGPointMake(420.88, 450.06) controlPoint1: CGPointMake(409.01, 445.53) controlPoint2: CGPointMake(416.35, 445.53)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(474.59, 281.81)];
        [bezier2Path addCurveToPoint: CGPointMake(474.59, 311.2) controlPoint1: CGPointMake(482.71, 289.93) controlPoint2: CGPointMake(482.71, 303.09)];
        [bezier2Path addCurveToPoint: CGPointMake(445.17, 311.2) controlPoint1: CGPointMake(466.46, 319.32) controlPoint2: CGPointMake(453.29, 319.32)];
        [bezier2Path addCurveToPoint: CGPointMake(445.17, 281.81) controlPoint1: CGPointMake(437.05, 303.09) controlPoint2: CGPointMake(437.05, 289.93)];
        [bezier2Path addCurveToPoint: CGPointMake(474.59, 281.81) controlPoint1: CGPointMake(453.29, 273.7) controlPoint2: CGPointMake(466.46, 273.7)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(589.08, 44.35)];
        [bezier2Path addLineToPoint: CGPointMake(165.48, 44.35)];
        [bezier2Path addCurveToPoint: CGPointMake(138.8, 147.83) controlPoint1: CGPointMake(152.79, 82.6) controlPoint2: CGPointMake(144.14, 116.75)];
        [bezier2Path addCurveToPoint: CGPointMake(608.27, 144.44) controlPoint1: CGPointMake(214.25, 147.29) controlPoint2: CGPointMake(518.69, 145.08)];
        [bezier2Path addCurveToPoint: CGPointMake(589.08, 44.35) controlPoint1: CGPointMake(604.71, 114.25) controlPoint2: CGPointMake(598.52, 81.17)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(611.65, 186.77)];
        [bezier2Path addCurveToPoint: CGPointMake(133.33, 190.23) controlPoint1: CGPointMake(523.9, 187.41) controlPoint2: CGPointMake(198.38, 189.76)];
        [bezier2Path addCurveToPoint: CGPointMake(185.18, 435.47) controlPoint1: CGPointMake(125.07, 289.27) controlPoint2: CGPointMake(152.78, 356.7)];
        [bezier2Path addCurveToPoint: CGPointMake(237.58, 979.14) controlPoint1: CGPointMake(234.48, 555.56) controlPoint2: CGPointMake(290.28, 691.12)];
        [bezier2Path addLineToPoint: CGPointMake(523.48, 979.14)];
        [bezier2Path addCurveToPoint: CGPointMake(563.08, 423.18) controlPoint1: CGPointMake(466.88, 679.33) controlPoint2: CGPointMake(517.98, 543.47)];
        [bezier2Path addCurveToPoint: CGPointMake(611.65, 186.77) controlPoint1: CGPointMake(590.6, 349.96) controlPoint2: CGPointMake(615.56, 283.53)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(621.68, 2)];
        [bezier2Path addCurveToPoint: CGPointMake(625.98, 17.58) controlPoint1: CGPointMake(621.68, 2) controlPoint2: CGPointMake(625.98, 17.58)];
        [bezier2Path addCurveToPoint: CGPointMake(602.88, 438.07) controlPoint1: CGPointMake(682.78, 225.28) controlPoint2: CGPointMake(643.98, 328.68)];
        [bezier2Path addCurveToPoint: CGPointMake(570.08, 996.12) controlPoint1: CGPointMake(558.48, 556.35) controlPoint2: CGPointMake(508.08, 690.42)];
        [bezier2Path addLineToPoint: CGPointMake(575.18, 1021.5)];
        [bezier2Path addLineToPoint: CGPointMake(186.18, 1021.5)];
        [bezier2Path addLineToPoint: CGPointMake(191.28, 996.22)];
        [bezier2Path addCurveToPoint: CGPointMake(145.98, 451.56) controlPoint1: CGPointMake(249.48, 703.31) controlPoint2: CGPointMake(194.48, 569.54)];
        [bezier2Path addCurveToPoint: CGPointMake(130.28, 16.18) controlPoint1: CGPointMake(99.38, 338.17) controlPoint2: CGPointMake(55.38, 231.17)];
        [bezier2Path addLineToPoint: CGPointMake(135.28, 2)];
        [bezier2Path addLineToPoint: CGPointMake(621.68, 2)];
        [bezier2Path addLineToPoint: CGPointMake(621.68, 2)];
        [bezier2Path closePath];
        [strokeColor setFill];
        [bezier2Path fill];
...
+ (void)drawSimilarSpotIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier 2 Drawing
        UIBezierPath* bezier2Path = UIBezierPath.bezierPath;
        [bezier2Path moveToPoint: CGPointMake(977, 80)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 160) controlPoint1: CGPointMake(977, 80) controlPoint2: CGPointMake(977, 160)];
        [bezier2Path addLineToPoint: CGPointMake(688.31, 160)];
        [bezier2Path addCurveToPoint: CGPointMake(622.45, 80) controlPoint1: CGPointMake(670.8, 129.9) controlPoint2: CGPointMake(648.5, 102.89)];
        [bezier2Path addLineToPoint: CGPointMake(977, 80)];
        [bezier2Path addLineToPoint: CGPointMake(977, 80)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(715.31, 220)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 220) controlPoint1: CGPointMake(715.31, 220) controlPoint2: CGPointMake(977, 220)];
        [bezier2Path addLineToPoint: CGPointMake(977, 300)];
        [bezier2Path addLineToPoint: CGPointMake(730.62, 300)];
        [bezier2Path addCurveToPoint: CGPointMake(715.31, 220) controlPoint1: CGPointMake(728.96, 272.24) controlPoint2: CGPointMake(723.7, 245.42)];
        [bezier2Path addLineToPoint: CGPointMake(715.31, 220)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(977, 360)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 440) controlPoint1: CGPointMake(977, 360) controlPoint2: CGPointMake(977, 440)];
        [bezier2Path addLineToPoint: CGPointMake(707.37, 440)];
        [bezier2Path addCurveToPoint: CGPointMake(728.58, 360) controlPoint1: CGPointMake(717.9, 414.4) controlPoint2: CGPointMake(725.04, 387.52)];
        [bezier2Path addLineToPoint: CGPointMake(977, 360)];
        [bezier2Path addLineToPoint: CGPointMake(977, 360)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(676.37, 500)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 500) controlPoint1: CGPointMake(676.37, 500) controlPoint2: CGPointMake(977, 500)];
        [bezier2Path addLineToPoint: CGPointMake(977, 580)];
        [bezier2Path addLineToPoint: CGPointMake(635.01, 580)];
        [bezier2Path addCurveToPoint: CGPointMake(676.37, 500) controlPoint1: CGPointMake(653.84, 543.58) controlPoint2: CGPointMake(668.64, 514.96)];
        [bezier2Path addLineToPoint: CGPointMake(676.37, 500)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(603.99, 640)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 640) controlPoint1: CGPointMake(603.99, 640) controlPoint2: CGPointMake(977, 640)];
        [bezier2Path addLineToPoint: CGPointMake(977, 720)];
        [bezier2Path addLineToPoint: CGPointMake(562.63, 720)];
        [bezier2Path addCurveToPoint: CGPointMake(603.99, 640) controlPoint1: CGPointMake(576.88, 692.44) controlPoint2: CGPointMake(590.87, 665.37)];
        [bezier2Path addLineToPoint: CGPointMake(603.99, 640)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(977, 770)];
        [bezier2Path addCurveToPoint: CGPointMake(977, 850) controlPoint1: CGPointMake(977, 770) controlPoint2: CGPointMake(977, 850)];
        [bezier2Path addLineToPoint: CGPointMake(495.42, 850)];
        [bezier2Path addCurveToPoint: CGPointMake(536.78, 770) controlPoint1: CGPointMake(508.67, 824.36) controlPoint2: CGPointMake(522.66, 797.3)];
        [bezier2Path addLineToPoint: CGPointMake(977, 770)];
        [bezier2Path addLineToPoint: CGPointMake(977, 770)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(352.8, 1017.53)];
        [bezier2Path addLineToPoint: CGPointMake(82.1, 488.83)];
        [bezier2Path addCurveToPoint: CGPointMake(33, 319.23) controlPoint1: CGPointMake(50, 438.03) controlPoint2: CGPointMake(33, 379.37)];
        [bezier2Path addCurveToPoint: CGPointMake(354.1, 0) controlPoint1: CGPointMake(33, 143.16) controlPoint2: CGPointMake(177.1, 0)];
        [bezier2Path addCurveToPoint: CGPointMake(675.2, 319.23) controlPoint1: CGPointMake(531.1, 0) controlPoint2: CGPointMake(675.2, 143.26)];
        [bezier2Path addCurveToPoint: CGPointMake(626.3, 488.53) controlPoint1: CGPointMake(675.2, 379.27) controlPoint2: CGPointMake(658.3, 437.83)];
        [bezier2Path addLineToPoint: CGPointMake(352.8, 1017.53)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(354.1, 46.43)];
        [bezier2Path addCurveToPoint: CGPointMake(79.7, 319.23) controlPoint1: CGPointMake(202.8, 46.43) controlPoint2: CGPointMake(79.7, 168.81)];
        [bezier2Path addCurveToPoint: CGPointMake(122.2, 464.87) controlPoint1: CGPointMake(79.7, 370.92) controlPoint2: CGPointMake(94.4, 421.33)];
        [bezier2Path addLineToPoint: CGPointMake(123.3, 466.76)];
        [bezier2Path addLineToPoint: CGPointMake(353.1, 915.43)];
        [bezier2Path addLineToPoint: CGPointMake(586.2, 464.57)];
        [bezier2Path addCurveToPoint: CGPointMake(628.5, 319.23) controlPoint1: CGPointMake(613.9, 421.03) controlPoint2: CGPointMake(628.5, 370.72)];
        [bezier2Path addCurveToPoint: CGPointMake(354.1, 46.43) controlPoint1: CGPointMake(628.4, 168.81) controlPoint2: CGPointMake(505.4, 46.43)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(359.1, 456.42)];
        [bezier2Path addCurveToPoint: CGPointMake(245.2, 343.19) controlPoint1: CGPointMake(296.3, 456.42) controlPoint2: CGPointMake(245.2, 405.62)];
        [bezier2Path addCurveToPoint: CGPointMake(359.1, 229.85) controlPoint1: CGPointMake(245.2, 280.75) controlPoint2: CGPointMake(296.3, 229.85)];
        [bezier2Path addCurveToPoint: CGPointMake(473, 343.19) controlPoint1: CGPointMake(421.9, 229.85) controlPoint2: CGPointMake(473, 280.65)];
        [bezier2Path addCurveToPoint: CGPointMake(359.1, 456.42) controlPoint1: CGPointMake(473, 405.72) controlPoint2: CGPointMake(421.9, 456.42)];
        [bezier2Path closePath];
        [bezier2Path moveToPoint: CGPointMake(359.1, 264.65)];
        [bezier2Path addCurveToPoint: CGPointMake(280.2, 343.09) controlPoint1: CGPointMake(315.6, 264.65) controlPoint2: CGPointMake(280.2, 299.84)];
        [bezier2Path addCurveToPoint: CGPointMake(359.1, 421.53) controlPoint1: CGPointMake(280.2, 386.33) controlPoint2: CGPointMake(315.6, 421.53)];
        [bezier2Path addCurveToPoint: CGPointMake(438, 343.09) controlPoint1: CGPointMake(402.6, 421.53) controlPoint2: CGPointMake(438, 386.33)];
        [bezier2Path addCurveToPoint: CGPointMake(359.1, 264.65) controlPoint1: CGPointMake(438, 299.84) controlPoint2: CGPointMake(402.6, 264.65)];
        [bezier2Path closePath];
        [strokeColor setFill];
        [bezier2Path fill];
...
+ (void)drawBottomBarBlackShadowBackground;
{
    ...
    CGGradientRef myDarkShadowGradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef)@[(id)SHStyleKit.myBlackTransparent.CGColor, (id)[UIColor colorWithRed: 0.5 green: 0.5 blue: 0.5 alpha: 0.375].CGColor, (id)SHStyleKit.myClearColor.CGColor], myDarkShadowGradientLocations);
