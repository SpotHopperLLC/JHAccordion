...
//  SpotHopper
//
//  Created by SpotHopper on 9/2/14.
...
+ (void)drawStarIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName fillColorName: (NSString*)fillColorName;
{
    ...
    //// Group
    {
        ...
        [starPath moveToPoint: CGPointMake(507, 48.5)];
        [starPath addLineToPoint: CGPointMake(673.99, 299.36)];
        [starPath addLineToPoint: CGPointMake(957.33, 385.35)];
        [starPath addLineToPoint: CGPointMake(777.2, 626.39)];
        [starPath addLineToPoint: CGPointMake(785.32, 930.4)];
        [starPath addLineToPoint: CGPointMake(507, 828.5)];
        [starPath addLineToPoint: CGPointMake(228.68, 930.4)];
        [starPath addLineToPoint: CGPointMake(236.8, 626.39)];
        [starPath addLineToPoint: CGPointMake(56.67, 385.35)];
        [starPath addLineToPoint: CGPointMake(340.01, 299.36)];
        [starPath closePath];
        [fillColor setFill];
        [starPath fill];
        [strokeColor setStroke];
