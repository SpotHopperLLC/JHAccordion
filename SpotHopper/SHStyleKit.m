...
//  SpotHopper
//
//  Created by SpotHopper on 7/3/14.
...
+ (void)drawDeleteIconWithScaleX: (CGFloat)scaleX scaleY: (CGFloat)scaleY strokeColorName: (NSString*)strokeColorName;
{
    ...
    //// Group
    {
        ...
        //// Bezier Drawing
        UIBezierPath* bezierPath = UIBezierPath.bezierPath;
        [bezierPath moveToPoint: CGPointMake(993.57, -1.9)];
        [bezierPath addCurveToPoint: CGPointMake(1023.76, 28.29) controlPoint1: CGPointMake(993.57, -1.9) controlPoint2: CGPointMake(1023.76, 28.29)];
        [bezierPath addCurveToPoint: CGPointMake(542.8, 509.26) controlPoint1: CGPointMake(1023.76, 28.29) controlPoint2: CGPointMake(785.69, 266.37)];
        [bezierPath addCurveToPoint: CGPointMake(1023.68, 990.16) controlPoint1: CGPointMake(785.66, 752.14) controlPoint2: CGPointMake(1023.68, 990.16)];
        [bezierPath addLineToPoint: CGPointMake(993.49, 1020.36)];
        [bezierPath addCurveToPoint: CGPointMake(512.6, 539.47) controlPoint1: CGPointMake(993.49, 1020.36) controlPoint2: CGPointMake(755.47, 782.34)];
        [bezierPath addCurveToPoint: CGPointMake(31.7, 1020.36) controlPoint1: CGPointMake(269.73, 782.33) controlPoint2: CGPointMake(31.7, 1020.36)];
        [bezierPath addLineToPoint: CGPointMake(1.51, 990.16)];
        [bezierPath addCurveToPoint: CGPointMake(482.4, 509.28) controlPoint1: CGPointMake(1.51, 990.16) controlPoint2: CGPointMake(239.53, 752.14)];
        [bezierPath addCurveToPoint: CGPointMake(1.43, 28.29) controlPoint1: CGPointMake(239.51, 266.37) controlPoint2: CGPointMake(1.43, 28.29)];
        [bezierPath addLineToPoint: CGPointMake(31.62, -1.9)];
        [bezierPath addCurveToPoint: CGPointMake(512.59, 479.07) controlPoint1: CGPointMake(31.62, -1.9) controlPoint2: CGPointMake(269.7, 236.17)];
        [bezierPath addCurveToPoint: CGPointMake(993.57, -1.9) controlPoint1: CGPointMake(755.49, 236.18) controlPoint2: CGPointMake(993.57, -1.9)];
        [bezierPath addLineToPoint: CGPointMake(993.57, -1.9)];
        [bezierPath closePath];
        [strokeColor setFill];
        [bezierPath fill];
