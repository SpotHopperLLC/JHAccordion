...
- (void)viewDidLoad {
    ...
    [SHStyleKit setButton:self.btnCheckIn withDrawing:SHStyleKitDrawingCheckinMarkIcon normalColor:SHStyleKitColorMyTextColor highlightedColor:SHStyleKitColorMyWhiteColor];
