...
- (void)viewDidLoad {
    ...
    [SHStyleKit setButton:self.btnCheckIn withDrawing:SHStyleKitDrawingCheckinIcon normalColor:SHStyleKitColorMyTextColor highlightedColor:SHStyleKitColorMyWhiteColor];
